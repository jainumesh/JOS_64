...
bc_init(void)
{
  ...
  800e22:	00 00 00 
  800e25:	48 b8 3c 4e 80 00 00 	movabs $0x804e3c,%rax
  800e2c:	00 00 00 
...
openfile_alloc(struct OpenFile **o)
{
  ...
  8021f8:	48 b8 6a 61 80 00 00 	movabs $0x80616a,%rax
  8021ff:	00 00 00 
...
openfile_lookup(envid_t envid, uint32_t fileid, struct OpenFile **po)
{
  ...
  80234d:	48 b8 6a 61 80 00 00 	movabs $0x80616a,%rax
  802354:	00 00 00 
...
serve(void)
{
  ...
  802986:	48 b8 7c 4f 80 00 00 	movabs $0x804f7c,%rax
  80298d:	00 00 00 
  ...
  802a7d:	48 b8 82 50 80 00 00 	movabs $0x805082,%rax
  802a84:	00 00 00 
...
exit(void)
{
  ...
  8033c4:	48 89 e5             	mov    %rsp,%rbp
	close_all();
  8033c7:	48 b8 a7 54 80 00 00 	movabs $0x8054a7,%rax
  8033ce:	00 00 00 
...
sys_net_tx(void *buf, size_t len)
{
  ...
  804d9c:	48 89 d1             	mov    %rdx,%rcx
  804d9f:	48 89 c2             	mov    %rax,%rdx
  804da2:	be 01 00 00 00       	mov    $0x1,%esi
  804da7:	bf 0f 00 00 00       	mov    $0xf,%edi
  804dac:	48 b8 2d 49 80 00 00 	movabs $0x80492d,%rax
  804db3:	00 00 00 
...
0000000000804dba <sys_net_rx>:

int
sys_net_rx(void *buf)
{
  804dba:	55                   	push   %rbp
  804dbb:	48 89 e5             	mov    %rsp,%rbp
  804dbe:	48 83 ec 10          	sub    $0x10,%rsp
  804dc2:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	return syscall(SYS_net_rx, 0, (uint64_t)buf, 0, 0, 0, 0);
  804dc6:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  804dca:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
  804dd1:	00 
  804dd2:	41 b9 00 00 00 00    	mov    $0x0,%r9d
  804dd8:	41 b8 00 00 00 00    	mov    $0x0,%r8d
  804dde:	b9 00 00 00 00       	mov    $0x0,%ecx
  804de3:	48 89 c2             	mov    %rax,%rdx
  804de6:	be 00 00 00 00       	mov    $0x0,%esi
  804deb:	bf 10 00 00 00       	mov    $0x10,%edi
  804df0:	48 b8 2d 49 80 00 00 	movabs $0x80492d,%rax
  804df7:	00 00 00 
...
0000000000804dfe <sys_time_msec>:
...
{
  804dfe:	55                   	push   %rbp
  804dff:	48 89 e5             	mov    %rsp,%rbp
  804e02:	48 83 ec 10          	sub    $0x10,%rsp
	return (unsigned int) syscall(SYS_time_msec, 0, 0, 0, 0, 0, 0);
  804e06:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
  804e0d:	00 
  804e0e:	41 b9 00 00 00 00    	mov    $0x0,%r9d
  804e14:	41 b8 00 00 00 00    	mov    $0x0,%r8d
  804e1a:	b9 00 00 00 00       	mov    $0x0,%ecx
  804e1f:	ba 00 00 00 00       	mov    $0x0,%edx
  804e24:	be 00 00 00 00       	mov    $0x0,%esi
  804e29:	bf 0e 00 00 00       	mov    $0xe,%edi
  804e2e:	48 b8 2d 49 80 00 00 	movabs $0x80492d,%rax
  804e35:	00 00 00 
...
0000000000804e3c <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  804e44:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
        int r;
        //struct Env *thisenv = NULL;
        if (_pgfault_handler == 0) {
  804e48:	48 b8 28 30 81 00 00 	movabs $0x813028,%rax
  804e4f:	00 00 00 
  804e52:	48 8b 00             	mov    (%rax),%rax
  804e55:	48 85 c0             	test   %rax,%rax
  804e58:	0f 85 84 00 00 00    	jne    804ee2 <set_pgfault_handler+0xa6>
                // First time through!
                // LAB 4: Your code here.
                //cprintf("Inside set_pgfault_handler");
                if(0> sys_page_alloc(thisenv->env_id, (void*)UXSTACKTOP - PGSIZE,PTE_U|PTE_P|PTE_W)){
  804e5e:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  804e65:	00 00 00 
  804e68:	48 8b 00             	mov    (%rax),%rax
  804e6b:	8b 80 c8 00 00 00    	mov    0xc8(%rax),%eax
  804e71:	ba 07 00 00 00       	mov    $0x7,%edx
  804e76:	be 00 f0 7f ef       	mov    $0xef7ff000,%esi
  804e7b:	89 c7                	mov    %eax,%edi
  804e7d:	48 b8 03 4b 80 00 00 	movabs $0x804b03,%rax
  804e84:	00 00 00 
  804e87:	ff d0                	callq  *%rax
  804e89:	85 c0                	test   %eax,%eax
  804e8b:	79 2a                	jns    804eb7 <set_pgfault_handler+0x7b>
                        panic("Page not available for exception stack");
  804e8d:	48 ba 78 7e 80 00 00 	movabs $0x807e78,%rdx
  804e94:	00 00 00 
  804e97:	be 23 00 00 00       	mov    $0x23,%esi
  804e9c:	48 bf 9f 7e 80 00 00 	movabs $0x807e9f,%rdi
  804ea3:	00 00 00 
  804ea6:	b8 00 00 00 00       	mov    $0x0,%eax
  804eab:	48 b9 e6 33 80 00 00 	movabs $0x8033e6,%rcx
  804eb2:	00 00 00 
  804eb5:	ff d1                	callq  *%rcx
                }
                sys_env_set_pgfault_upcall(thisenv->env_id, (void*)_pgfault_upcall);
  804eb7:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  804ebe:	00 00 00 
  804ec1:	48 8b 00             	mov    (%rax),%rax
  804ec4:	8b 80 c8 00 00 00    	mov    0xc8(%rax),%eax
  804eca:	48 be f5 4e 80 00 00 	movabs $0x804ef5,%rsi
  804ed1:	00 00 00 
  804ed4:	89 c7                	mov    %eax,%edi
  804ed6:	48 b8 8d 4c 80 00 00 	movabs $0x804c8d,%rax
  804edd:	00 00 00 
  ...
  804ee2:	48 b8 28 30 81 00 00 	movabs $0x813028,%rax
  804ee9:	00 00 00 
  804eec:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  804ef0:	48 89 10             	mov    %rdx,(%rax)
}
  804ef3:	c9                   	leaveq 
  804ef4:	c3                   	retq   

0000000000804ef5 <_pgfault_upcall>:
...
movq  %rsp,%rdi                // passing the function argument in rdi
  804ef5:	48 89 e7             	mov    %rsp,%rdi
movabs _pgfault_handler, %rax
  804ef8:	48 a1 28 30 81 00 00 	movabs 0x813028,%rax
  804eff:	00 00 00 
call *%rax
  ...
  804f04:	48 8b 9c 24 88 00 00 	mov    0x88(%rsp),%rbx
  804f0b:	00 
	movq 152(%rsp), %rcx  //Load RSP
  804f0c:	48 8b 8c 24 98 00 00 	mov    0x98(%rsp),%rcx
  804f13:	00 
	//Move pointer on the stack and save the RIP on trap time stack 
	subq $8, %rcx          
  804f14:	48 83 e9 08          	sub    $0x8,%rcx
	movq %rbx, (%rcx) 
  804f18:	48 89 19             	mov    %rbx,(%rcx)
	//Now update value of trap time stack rsp after pushing rip in UXSTACKTOP
	movq %rcx, 152(%rsp)
  804f1b:	48 89 8c 24 98 00 00 	mov    %rcx,0x98(%rsp)
  804f22:	00 
	...
	// LAB 4: Your code here.
	addq $16,%rsp
  804f23:	48 83 c4 10          	add    $0x10,%rsp
	POPA_ 
  804f27:	4c 8b 3c 24          	mov    (%rsp),%r15
  804f2b:	4c 8b 74 24 08       	mov    0x8(%rsp),%r14
  804f30:	4c 8b 6c 24 10       	mov    0x10(%rsp),%r13
  804f35:	4c 8b 64 24 18       	mov    0x18(%rsp),%r12
  804f3a:	4c 8b 5c 24 20       	mov    0x20(%rsp),%r11
  804f3f:	4c 8b 54 24 28       	mov    0x28(%rsp),%r10
  804f44:	4c 8b 4c 24 30       	mov    0x30(%rsp),%r9
  804f49:	4c 8b 44 24 38       	mov    0x38(%rsp),%r8
  804f4e:	48 8b 74 24 40       	mov    0x40(%rsp),%rsi
  804f53:	48 8b 7c 24 48       	mov    0x48(%rsp),%rdi
  804f58:	48 8b 6c 24 50       	mov    0x50(%rsp),%rbp
  804f5d:	48 8b 54 24 58       	mov    0x58(%rsp),%rdx
  804f62:	48 8b 4c 24 60       	mov    0x60(%rsp),%rcx
  804f67:	48 8b 5c 24 68       	mov    0x68(%rsp),%rbx
  804f6c:	48 8b 44 24 70       	mov    0x70(%rsp),%rax
  804f71:	48 83 c4 78          	add    $0x78,%rsp
	// Restore eflags from the stack.  After you do this, you can
	// no longer use arithmetic operations or anything else that
	// modifies eflags.
	// LAB 4: Your code here.
	addq $8, %rsp
  804f75:	48 83 c4 08          	add    $0x8,%rsp
	popfq
  804f79:	9d                   	popfq  
...
{
  804f7c:	55                   	push   %rbp
  804f7d:	48 89 e5             	mov    %rsp,%rbp
  804f80:	48 83 ec 30          	sub    $0x30,%rsp
  804f84:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  804f88:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  804f8c:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	// LAB 4: Your code here.
	int result;
	if(thisenv->env_status== 0){
  804f90:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  804f97:	00 00 00 
  804f9a:	48 8b 00             	mov    (%rax),%rax
  804f9d:	8b 80 d4 00 00 00    	mov    0xd4(%rax),%eax
  804fa3:	85 c0                	test   %eax,%eax
  804fa5:	75 3c                	jne    804fe3 <ipc_recv+0x67>
		thisenv = &envs[ENVX(sys_getenvid())];
  804fa7:	48 b8 87 4a 80 00 00 	movabs $0x804a87,%rax
  804fae:	00 00 00 
  804fb1:	ff d0                	callq  *%rax
  804fb3:	25 ff 03 00 00       	and    $0x3ff,%eax
  804fb8:	48 63 d0             	movslq %eax,%rdx
  804fbb:	48 89 d0             	mov    %rdx,%rax
  804fbe:	48 c1 e0 03          	shl    $0x3,%rax
  804fc2:	48 01 d0             	add    %rdx,%rax
  804fc5:	48 c1 e0 05          	shl    $0x5,%rax
  804fc9:	48 ba 00 00 80 00 80 	movabs $0x8000800000,%rdx
  804fd0:	00 00 00 
  804fd3:	48 01 c2             	add    %rax,%rdx
  804fd6:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  804fdd:	00 00 00 
  804fe0:	48 89 10             	mov    %rdx,(%rax)
	}
	if(!pg)
  804fe3:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
  804fe8:	75 0e                	jne    804ff8 <ipc_recv+0x7c>
		pg = (void*) UTOP;
  804fea:	48 b8 00 00 80 00 80 	movabs $0x8000800000,%rax
  804ff1:	00 00 00 
  804ff4:	48 89 45 e0          	mov    %rax,-0x20(%rbp)

	result = sys_ipc_recv(pg);
  804ff8:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  804ffc:	48 89 c7             	mov    %rax,%rdi
  804fff:	48 b8 2c 4d 80 00 00 	movabs $0x804d2c,%rax
  805006:	00 00 00 
  805009:	ff d0                	callq  *%rax
  80500b:	89 45 fc             	mov    %eax,-0x4(%rbp)
	if(result< 0){
  80500e:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805012:	79 19                	jns    80502d <ipc_recv+0xb1>
		*from_env_store = 0;
  805014:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805018:	c7 00 00 00 00 00    	movl   $0x0,(%rax)
		*perm_store =0;
  80501e:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  805022:	c7 00 00 00 00 00    	movl   $0x0,(%rax)
		return result;
  805028:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80502b:	eb 53                	jmp    805080 <ipc_recv+0x104>
	}
	if(from_env_store)
  80502d:	48 83 7d e8 00       	cmpq   $0x0,-0x18(%rbp)
  805032:	74 19                	je     80504d <ipc_recv+0xd1>
		*from_env_store = thisenv->env_ipc_from;
  805034:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  80503b:	00 00 00 
  80503e:	48 8b 00             	mov    (%rax),%rax
  805041:	8b 90 0c 01 00 00    	mov    0x10c(%rax),%edx
  805047:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  80504b:	89 10                	mov    %edx,(%rax)
	if(perm_store)
  80504d:	48 83 7d d8 00       	cmpq   $0x0,-0x28(%rbp)
  805052:	74 19                	je     80506d <ipc_recv+0xf1>
		*perm_store = thisenv->env_ipc_perm;
  805054:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  80505b:	00 00 00 
  80505e:	48 8b 00             	mov    (%rax),%rax
  805061:	8b 90 10 01 00 00    	mov    0x110(%rax),%edx
  805067:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  80506b:	89 10                	mov    %edx,(%rax)
	
	//cprintf("I am IPC Recv, sending value[%d] my env id is [%d]and status is [%d] and I am sending to [%d]",thisenv->env_ipc_value,thisenv->env_id,thisenv->env_status,thisenv->env_ipc_from);	
	return thisenv->env_ipc_value;
  80506d:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  805074:	00 00 00 
  805077:	48 8b 00             	mov    (%rax),%rax
  80507a:	8b 80 08 01 00 00    	mov    0x108(%rax),%eax
...
{
  805082:	55                   	push   %rbp
  805083:	48 89 e5             	mov    %rsp,%rbp
  805086:	48 83 ec 30          	sub    $0x30,%rsp
  80508a:	89 7d ec             	mov    %edi,-0x14(%rbp)
  80508d:	89 75 e8             	mov    %esi,-0x18(%rbp)
  805090:	48 89 55 e0          	mov    %rdx,-0x20(%rbp)
  805094:	89 4d dc             	mov    %ecx,-0x24(%rbp)
	// LAB 4: Your code here.
	int result;
	if(!pg)
  805097:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
  80509c:	75 0e                	jne    8050ac <ipc_send+0x2a>
		pg = (void*)UTOP;
  80509e:	48 b8 00 00 80 00 80 	movabs $0x8000800000,%rax
  8050a5:	00 00 00 
  8050a8:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
	do{
	 	result = sys_ipc_try_send(to_env,val,pg,perm);
  8050ac:	8b 75 e8             	mov    -0x18(%rbp),%esi
  8050af:	8b 4d dc             	mov    -0x24(%rbp),%ecx
  8050b2:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
  8050b6:	8b 45 ec             	mov    -0x14(%rbp),%eax
  8050b9:	89 c7                	mov    %eax,%edi
  8050bb:	48 b8 d7 4c 80 00 00 	movabs $0x804cd7,%rax
  8050c2:	00 00 00 
  8050c5:	ff d0                	callq  *%rax
  8050c7:	89 45 fc             	mov    %eax,-0x4(%rbp)
		if(-E_IPC_NOT_RECV == result)
  8050ca:	83 7d fc f8          	cmpl   $0xfffffff8,-0x4(%rbp)
  8050ce:	75 0c                	jne    8050dc <ipc_send+0x5a>
			sys_yield();
  8050d0:	48 b8 c5 4a 80 00 00 	movabs $0x804ac5,%rax
  8050d7:	00 00 00 
  8050da:	ff d0                	callq  *%rax
	}while(-E_IPC_NOT_RECV == result);
  8050dc:	83 7d fc f8          	cmpl   $0xfffffff8,-0x4(%rbp)
  8050e0:	74 ca                	je     8050ac <ipc_send+0x2a>
...
ipc_find_env(enum EnvType type)
{
  ...
  8050e8:	48 83 ec 14          	sub    $0x14,%rsp
  8050ec:	89 7d ec             	mov    %edi,-0x14(%rbp)
	int i;
	for (i = 0; i < NENV; i++) {
  8050ef:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  8050f6:	eb 5e                	jmp    805156 <ipc_find_env+0x72>
		if (envs[i].env_type == type)
  8050f8:	48 b9 00 00 80 00 80 	movabs $0x8000800000,%rcx
  8050ff:	00 00 00 
  805102:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805105:	48 63 d0             	movslq %eax,%rdx
  805108:	48 89 d0             	mov    %rdx,%rax
  80510b:	48 c1 e0 03          	shl    $0x3,%rax
  80510f:	48 01 d0             	add    %rdx,%rax
  805112:	48 c1 e0 05          	shl    $0x5,%rax
  805116:	48 01 c8             	add    %rcx,%rax
  805119:	48 05 d0 00 00 00    	add    $0xd0,%rax
  80511f:	8b 00                	mov    (%rax),%eax
  805121:	3b 45 ec             	cmp    -0x14(%rbp),%eax
  805124:	75 2c                	jne    805152 <ipc_find_env+0x6e>
			return envs[i].env_id;
  805126:	48 b9 00 00 80 00 80 	movabs $0x8000800000,%rcx
  80512d:	00 00 00 
  805130:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805133:	48 63 d0             	movslq %eax,%rdx
  805136:	48 89 d0             	mov    %rdx,%rax
  805139:	48 c1 e0 03          	shl    $0x3,%rax
  80513d:	48 01 d0             	add    %rdx,%rax
  805140:	48 c1 e0 05          	shl    $0x5,%rax
  805144:	48 01 c8             	add    %rcx,%rax
  805147:	48 05 c0 00 00 00    	add    $0xc0,%rax
  80514d:	8b 40 08             	mov    0x8(%rax),%eax
  805150:	eb 12                	jmp    805164 <ipc_find_env+0x80>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++) {
  805152:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
  805156:	81 7d fc ff 03 00 00 	cmpl   $0x3ff,-0x4(%rbp)
  80515d:	7e 99                	jle    8050f8 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	}
	return 0;
...
fd2num(struct Fd *fd)
{
  ...
  80516a:	48 83 ec 08          	sub    $0x8,%rsp
  80516e:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	return ((uintptr_t) fd - FDTABLE) / PGSIZE;
  805172:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  805176:	48 b8 00 00 00 30 ff 	movabs $0xffffffff30000000,%rax
  80517d:	ff ff ff 
  805180:	48 01 d0             	add    %rdx,%rax
  805183:	48 c1 e8 0c          	shr    $0xc,%rax
}
  805187:	c9                   	leaveq 
  805188:	c3                   	retq   

0000000000805189 <fd2data>:

char*
fd2data(struct Fd *fd)
{
  805189:	55                   	push   %rbp
  80518a:	48 89 e5             	mov    %rsp,%rbp
  80518d:	48 83 ec 08          	sub    $0x8,%rsp
  805191:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	return INDEX2DATA(fd2num(fd));
  805195:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  805199:	48 89 c7             	mov    %rax,%rdi
  80519c:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  8051a3:	00 00 00 
  8051a6:	ff d0                	callq  *%rax
  8051a8:	48 05 20 00 0d 00    	add    $0xd0020,%rax
  8051ae:	48 c1 e0 0c          	shl    $0xc,%rax
}
  8051b2:	c9                   	leaveq 
  8051b3:	c3                   	retq   

00000000008051b4 <fd_alloc>:
...
{
  8051b4:	55                   	push   %rbp
  8051b5:	48 89 e5             	mov    %rsp,%rbp
  8051b8:	48 83 ec 18          	sub    $0x18,%rsp
  8051bc:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
	int i;
	struct Fd *fd;

	for (i = 0; i < MAXFD; i++) {
  8051c0:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  8051c7:	eb 6b                	jmp    805234 <fd_alloc+0x80>
		fd = INDEX2FD(i);
  8051c9:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8051cc:	48 98                	cltq   
  8051ce:	48 05 00 00 0d 00    	add    $0xd0000,%rax
  8051d4:	48 c1 e0 0c          	shl    $0xc,%rax
  8051d8:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
		if ((uvpd[VPD(fd)] & PTE_P) == 0 || (uvpt[PGNUM(fd)] & PTE_P) == 0) {
  8051dc:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  ...
  8051fb:	74 21                	je     80521e <fd_alloc+0x6a>
  8051fd:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805201:	48 c1 e8 0c          	shr    $0xc,%rax
  805205:	48 89 c2             	mov    %rax,%rdx
  805208:	48 b8 00 00 00 00 00 	movabs $0x10000000000,%rax
  80520f:	01 00 00 
  805212:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  805216:	83 e0 01             	and    $0x1,%eax
  805219:	48 85 c0             	test   %rax,%rax
  80521c:	75 12                	jne    805230 <fd_alloc+0x7c>
			*fd_store = fd;
  80521e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805222:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  805226:	48 89 10             	mov    %rdx,(%rax)
			return 0;
  805229:	b8 00 00 00 00       	mov    $0x0,%eax
  80522e:	eb 1a                	jmp    80524a <fd_alloc+0x96>
fd_alloc(struct Fd **fd_store)
{
	int i;
	struct Fd *fd;
	...
	for (i = 0; i < MAXFD; i++) {
  805230:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
  805234:	83 7d fc 1f          	cmpl   $0x1f,-0x4(%rbp)
  805238:	7e 8f                	jle    8051c9 <fd_alloc+0x15>
		if ((uvpd[VPD(fd)] & PTE_P) == 0 || (uvpt[PGNUM(fd)] & PTE_P) == 0) {
			*fd_store = fd;
			return 0;
		}
	...
	*fd_store = 0;
  80523a:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  80523e:	48 c7 00 00 00 00 00 	movq   $0x0,(%rax)
	return -E_MAX_OPEN;
  805245:	b8 f5 ff ff ff       	mov    $0xfffffff5,%eax
}
  80524a:	c9                   	leaveq 
  80524b:	c3                   	retq   

000000000080524c <fd_lookup>:
...
{
  80524c:	55                   	push   %rbp
  80524d:	48 89 e5             	mov    %rsp,%rbp
  805250:	48 83 ec 20          	sub    $0x20,%rsp
  805254:	89 7d ec             	mov    %edi,-0x14(%rbp)
  805257:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
	struct Fd *fd;

	if (fdnum < 0 || fdnum >= MAXFD) {
  80525b:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  80525f:	78 06                	js     805267 <fd_lookup+0x1b>
  805261:	83 7d ec 1f          	cmpl   $0x1f,-0x14(%rbp)
  805265:	7e 07                	jle    80526e <fd_lookup+0x22>
		if (debug)
			cprintf("[%08x] bad fd %d\n", thisenv->env_id, fdnum);
		return -E_INVAL;
  805267:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  80526c:	eb 6c                	jmp    8052da <fd_lookup+0x8e>
	}
	fd = INDEX2FD(fdnum);
  80526e:	8b 45 ec             	mov    -0x14(%rbp),%eax
  805271:	48 98                	cltq   
  805273:	48 05 00 00 0d 00    	add    $0xd0000,%rax
  805279:	48 c1 e0 0c          	shl    $0xc,%rax
  80527d:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
	if (!(uvpd[VPD(fd)] & PTE_P) || !(uvpt[PGNUM(fd)] & PTE_P)) {
  805281:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  805285:	48 c1 e8 15          	shr    $0x15,%rax
  805289:	48 89 c2             	mov    %rax,%rdx
  80528c:	48 b8 00 00 00 80 00 	movabs $0x10080000000,%rax
  805293:	01 00 00 
  805296:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  80529a:	83 e0 01             	and    $0x1,%eax
  80529d:	48 85 c0             	test   %rax,%rax
  8052a0:	74 21                	je     8052c3 <fd_lookup+0x77>
  8052a2:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  8052a6:	48 c1 e8 0c          	shr    $0xc,%rax
  8052aa:	48 89 c2             	mov    %rax,%rdx
  8052ad:	48 b8 00 00 00 00 00 	movabs $0x10000000000,%rax
  8052b4:	01 00 00 
  8052b7:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  8052bb:	83 e0 01             	and    $0x1,%eax
  8052be:	48 85 c0             	test   %rax,%rax
  8052c1:	75 07                	jne    8052ca <fd_lookup+0x7e>
		if (debug)
			cprintf("[%08x] closed fd %d\n", thisenv->env_id, fdnum);
		return -E_INVAL;
  8052c3:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  8052c8:	eb 10                	jmp    8052da <fd_lookup+0x8e>
	}
	*fd_store = fd;
  8052ca:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  8052ce:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  8052d2:	48 89 10             	mov    %rdx,(%rax)
	return 0;
...
{
  8052dc:	55                   	push   %rbp
  8052dd:	48 89 e5             	mov    %rsp,%rbp
  8052e0:	48 83 ec 30          	sub    $0x30,%rsp
  8052e4:	48 89 7d d8          	mov    %rdi,-0x28(%rbp)
  8052e8:	89 f0                	mov    %esi,%eax
  8052ea:	88 45 d4             	mov    %al,-0x2c(%rbp)
	struct Fd *fd2;
	struct Dev *dev;
	int r;
	if ((r = fd_lookup(fd2num(fd), &fd2)) < 0
  8052ed:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  8052f1:	48 89 c7             	mov    %rax,%rdi
  8052f4:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  8052fb:	00 00 00 
  8052fe:	ff d0                	callq  *%rax
  805300:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  805304:	48 89 d6             	mov    %rdx,%rsi
  805307:	89 c7                	mov    %eax,%edi
  805309:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  805310:	00 00 00 
  805313:	ff d0                	callq  *%rax
  805315:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805318:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80531c:	78 0a                	js     805328 <fd_close+0x4c>
	    || fd != fd2)
  80531e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805322:	48 39 45 d8          	cmp    %rax,-0x28(%rbp)
  805326:	74 12                	je     80533a <fd_close+0x5e>
		return (must_exist ? r : 0);
  805328:	80 7d d4 00          	cmpb   $0x0,-0x2c(%rbp)
  80532c:	74 05                	je     805333 <fd_close+0x57>
  80532e:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805331:	eb 05                	jmp    805338 <fd_close+0x5c>
  805333:	b8 00 00 00 00       	mov    $0x0,%eax
  805338:	eb 69                	jmp    8053a3 <fd_close+0xc7>
	if ((r = dev_lookup(fd->fd_dev_id, &dev)) >= 0) {
  80533a:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  80533e:	8b 00                	mov    (%rax),%eax
  805340:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
  805344:	48 89 d6             	mov    %rdx,%rsi
  805347:	89 c7                	mov    %eax,%edi
  805349:	48 b8 a5 53 80 00 00 	movabs $0x8053a5,%rax
  805350:	00 00 00 
  805353:	ff d0                	callq  *%rax
  805355:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805358:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80535c:	78 2a                	js     805388 <fd_close+0xac>
		if (dev->dev_close)
  80535e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805362:	48 8b 40 20          	mov    0x20(%rax),%rax
  805366:	48 85 c0             	test   %rax,%rax
  805369:	74 16                	je     805381 <fd_close+0xa5>
			r = (*dev->dev_close)(fd);
  80536b:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  80536f:	48 8b 40 20          	mov    0x20(%rax),%rax
  805373:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
  805377:	48 89 d7             	mov    %rdx,%rdi
  80537a:	ff d0                	callq  *%rax
  80537c:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80537f:	eb 07                	jmp    805388 <fd_close+0xac>
		else
			r = 0;
  805381:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
	}
	// Make sure fd is unmapped.  Might be a no-op if
	// (*dev->dev_close)(fd) already unmapped it.
	(void) sys_page_unmap(0, fd);
  805388:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  80538c:	48 89 c6             	mov    %rax,%rsi
  80538f:	bf 00 00 00 00       	mov    $0x0,%edi
  805394:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  80539b:	00 00 00 
  80539e:	ff d0                	callq  *%rax
	return r;
  8053a0:	8b 45 fc             	mov    -0x4(%rbp),%eax
}
  8053a3:	c9                   	leaveq 
  8053a4:	c3                   	retq   

00000000008053a5 <dev_lookup>:
	0
};
...
{
  8053a5:	55                   	push   %rbp
  8053a6:	48 89 e5             	mov    %rsp,%rbp
  8053a9:	48 83 ec 20          	sub    $0x20,%rsp
  8053ad:	89 7d ec             	mov    %edi,-0x14(%rbp)
  8053b0:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
	int i;
	for (i = 0; devtab[i]; i++)
  8053b4:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  8053bb:	eb 41                	jmp    8053fe <dev_lookup+0x59>
		if (devtab[i]->dev_id == dev_id) {
  8053bd:	48 b8 a0 20 81 00 00 	movabs $0x8120a0,%rax
  8053c4:	00 00 00 
  8053c7:	8b 55 fc             	mov    -0x4(%rbp),%edx
  8053ca:	48 63 d2             	movslq %edx,%rdx
  8053cd:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  8053d1:	8b 00                	mov    (%rax),%eax
  8053d3:	3b 45 ec             	cmp    -0x14(%rbp),%eax
  8053d6:	75 22                	jne    8053fa <dev_lookup+0x55>
			*dev = devtab[i];
  8053d8:	48 b8 a0 20 81 00 00 	movabs $0x8120a0,%rax
  8053df:	00 00 00 
  8053e2:	8b 55 fc             	mov    -0x4(%rbp),%edx
  8053e5:	48 63 d2             	movslq %edx,%rdx
  8053e8:	48 8b 14 d0          	mov    (%rax,%rdx,8),%rdx
  8053ec:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  8053f0:	48 89 10             	mov    %rdx,(%rax)
			return 0;
  8053f3:	b8 00 00 00 00       	mov    $0x0,%eax
  8053f8:	eb 60                	jmp    80545a <dev_lookup+0xb5>
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8053fa:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
  8053fe:	48 b8 a0 20 81 00 00 	movabs $0x8120a0,%rax
  805405:	00 00 00 
  805408:	8b 55 fc             	mov    -0x4(%rbp),%edx
  80540b:	48 63 d2             	movslq %edx,%rdx
  80540e:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  805412:	48 85 c0             	test   %rax,%rax
  805415:	75 a6                	jne    8053bd <dev_lookup+0x18>
		if (devtab[i]->dev_id == dev_id) {
			*dev = devtab[i];
			return 0;
		}
	cprintf("[%08x] unknown device type %d\n", thisenv->env_id, dev_id);
  805417:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  80541e:	00 00 00 
  805421:	48 8b 00             	mov    (%rax),%rax
  805424:	8b 80 c8 00 00 00    	mov    0xc8(%rax),%eax
  80542a:	8b 55 ec             	mov    -0x14(%rbp),%edx
  80542d:	89 c6                	mov    %eax,%esi
  80542f:	48 bf b0 7e 80 00 00 	movabs $0x807eb0,%rdi
  805436:	00 00 00 
  805439:	b8 00 00 00 00       	mov    $0x0,%eax
  80543e:	48 b9 1f 36 80 00 00 	movabs $0x80361f,%rcx
  805445:	00 00 00 
  805448:	ff d1                	callq  *%rcx
	*dev = 0;
  80544a:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  80544e:	48 c7 00 00 00 00 00 	movq   $0x0,(%rax)
	return -E_INVAL;
  805455:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
}
  80545a:	c9                   	leaveq 
  80545b:	c3                   	retq   

000000000080545c <close>:

int
close(int fdnum)
{
  80545c:	55                   	push   %rbp
  80545d:	48 89 e5             	mov    %rsp,%rbp
  805460:	48 83 ec 20          	sub    $0x20,%rsp
  805464:	89 7d ec             	mov    %edi,-0x14(%rbp)
	struct Fd *fd;
	int r;

	if ((r = fd_lookup(fdnum, &fd)) < 0)
  805467:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  80546b:	8b 45 ec             	mov    -0x14(%rbp),%eax
  80546e:	48 89 d6             	mov    %rdx,%rsi
  805471:	89 c7                	mov    %eax,%edi
  805473:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  80547a:	00 00 00 
  80547d:	ff d0                	callq  *%rax
  80547f:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805482:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805486:	79 05                	jns    80548d <close+0x31>
		return r;
  805488:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80548b:	eb 18                	jmp    8054a5 <close+0x49>
	else
		return fd_close(fd, 1);
  80548d:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805491:	be 01 00 00 00       	mov    $0x1,%esi
  805496:	48 89 c7             	mov    %rax,%rdi
  805499:	48 b8 dc 52 80 00 00 	movabs $0x8052dc,%rax
  8054a0:	00 00 00 
  8054a3:	ff d0                	callq  *%rax
}
  8054a5:	c9                   	leaveq 
  8054a6:	c3                   	retq   

00000000008054a7 <close_all>:
...
close_all(void)
{
  ...
  8054ab:	48 83 ec 10          	sub    $0x10,%rsp
	int i;
	for (i = 0; i < MAXFD; i++)
  8054af:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  8054b6:	eb 15                	jmp    8054cd <close_all+0x26>
		close(i);
  8054b8:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8054bb:	89 c7                	mov    %eax,%edi
  8054bd:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  8054c4:	00 00 00 
  8054c7:	ff d0                	callq  *%rax
...
close_all(void)
{
	int i;
	for (i = 0; i < MAXFD; i++)
  8054c9:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
  8054cd:	83 7d fc 1f          	cmpl   $0x1f,-0x4(%rbp)
  8054d1:	7e e5                	jle    8054b8 <close_all+0x11>
		close(i);
}
  8054d3:	c9                   	leaveq 
  8054d4:	c3                   	retq   

00000000008054d5 <dup>:
...
{
  8054d5:	55                   	push   %rbp
  8054d6:	48 89 e5             	mov    %rsp,%rbp
  8054d9:	48 83 ec 40          	sub    $0x40,%rsp
  8054dd:	89 7d cc             	mov    %edi,-0x34(%rbp)
  8054e0:	89 75 c8             	mov    %esi,-0x38(%rbp)
	int r;
	char *ova, *nva;
	pte_t pte;
  ...
  8054e3:	48 8d 55 d8          	lea    -0x28(%rbp),%rdx
  8054e7:	8b 45 cc             	mov    -0x34(%rbp),%eax
  8054ea:	48 89 d6             	mov    %rdx,%rsi
  8054ed:	89 c7                	mov    %eax,%edi
  8054ef:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  8054f6:	00 00 00 
  8054f9:	ff d0                	callq  *%rax
  8054fb:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8054fe:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805502:	79 08                	jns    80550c <dup+0x37>
		return r;
  805504:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805507:	e9 70 01 00 00       	jmpq   80567c <dup+0x1a7>
	close(newfdnum);
  80550c:	8b 45 c8             	mov    -0x38(%rbp),%eax
  80550f:	89 c7                	mov    %eax,%edi
  805511:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  805518:	00 00 00 
  80551b:	ff d0                	callq  *%rax

	newfd = INDEX2FD(newfdnum);
  80551d:	8b 45 c8             	mov    -0x38(%rbp),%eax
  805520:	48 98                	cltq   
  805522:	48 05 00 00 0d 00    	add    $0xd0000,%rax
  805528:	48 c1 e0 0c          	shl    $0xc,%rax
  80552c:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
	ova = fd2data(oldfd);
  805530:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  805534:	48 89 c7             	mov    %rax,%rdi
  805537:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  80553e:	00 00 00 
  805541:	ff d0                	callq  *%rax
  805543:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
	nva = fd2data(newfd);
  805547:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  80554b:	48 89 c7             	mov    %rax,%rdi
  80554e:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  805555:	00 00 00 
  805558:	ff d0                	callq  *%rax
  80555a:	48 89 45 e0          	mov    %rax,-0x20(%rbp)

	if ((uvpd[VPD(ova)] & PTE_P) && (uvpt[PGNUM(ova)] & PTE_P))
  80555e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805562:	48 c1 e8 15          	shr    $0x15,%rax
  805566:	48 89 c2             	mov    %rax,%rdx
  805569:	48 b8 00 00 00 80 00 	movabs $0x10080000000,%rax
  805570:	01 00 00 
  805573:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  805577:	83 e0 01             	and    $0x1,%eax
  80557a:	48 85 c0             	test   %rax,%rax
  80557d:	74 73                	je     8055f2 <dup+0x11d>
  80557f:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805583:	48 c1 e8 0c          	shr    $0xc,%rax
  805587:	48 89 c2             	mov    %rax,%rdx
  80558a:	48 b8 00 00 00 00 00 	movabs $0x10000000000,%rax
  805591:	01 00 00 
  805594:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  805598:	83 e0 01             	and    $0x1,%eax
  80559b:	48 85 c0             	test   %rax,%rax
  80559e:	74 52                	je     8055f2 <dup+0x11d>
		if ((r = sys_page_map(0, ova, 0, nva, uvpt[PGNUM(ova)] & PTE_SYSCALL)) < 0)
  8055a0:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8055a4:	48 c1 e8 0c          	shr    $0xc,%rax
  8055a8:	48 89 c2             	mov    %rax,%rdx
  8055ab:	48 b8 00 00 00 00 00 	movabs $0x10000000000,%rax
  8055b2:	01 00 00 
  8055b5:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  8055b9:	25 07 0e 00 00       	and    $0xe07,%eax
  8055be:	89 c1                	mov    %eax,%ecx
  8055c0:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
  8055c4:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8055c8:	41 89 c8             	mov    %ecx,%r8d
  8055cb:	48 89 d1             	mov    %rdx,%rcx
  8055ce:	ba 00 00 00 00       	mov    $0x0,%edx
  8055d3:	48 89 c6             	mov    %rax,%rsi
  8055d6:	bf 00 00 00 00       	mov    $0x0,%edi
  8055db:	48 b8 53 4b 80 00 00 	movabs $0x804b53,%rax
  8055e2:	00 00 00 
  8055e5:	ff d0                	callq  *%rax
  8055e7:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8055ea:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8055ee:	79 02                	jns    8055f2 <dup+0x11d>
			goto err;
  8055f0:	eb 57                	jmp    805649 <dup+0x174>
	if ((r = sys_page_map(0, oldfd, 0, newfd, uvpt[PGNUM(oldfd)] & PTE_SYSCALL)) < 0)
  8055f2:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  8055f6:	48 c1 e8 0c          	shr    $0xc,%rax
  8055fa:	48 89 c2             	mov    %rax,%rdx
  8055fd:	48 b8 00 00 00 00 00 	movabs $0x10000000000,%rax
  805604:	01 00 00 
  805607:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  80560b:	25 07 0e 00 00       	and    $0xe07,%eax
  805610:	89 c1                	mov    %eax,%ecx
  805612:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  805616:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  80561a:	41 89 c8             	mov    %ecx,%r8d
  80561d:	48 89 d1             	mov    %rdx,%rcx
  805620:	ba 00 00 00 00       	mov    $0x0,%edx
  805625:	48 89 c6             	mov    %rax,%rsi
  805628:	bf 00 00 00 00       	mov    $0x0,%edi
  80562d:	48 b8 53 4b 80 00 00 	movabs $0x804b53,%rax
  805634:	00 00 00 
  805637:	ff d0                	callq  *%rax
  805639:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80563c:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805640:	79 02                	jns    805644 <dup+0x16f>
		goto err;
  805642:	eb 05                	jmp    805649 <dup+0x174>

	return newfdnum;
  805644:	8b 45 c8             	mov    -0x38(%rbp),%eax
  805647:	eb 33                	jmp    80567c <dup+0x1a7>

err:
	sys_page_unmap(0, newfd);
  805649:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  80564d:	48 89 c6             	mov    %rax,%rsi
  805650:	bf 00 00 00 00       	mov    $0x0,%edi
  805655:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  80565c:	00 00 00 
  80565f:	ff d0                	callq  *%rax
	sys_page_unmap(0, nva);
  805661:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805665:	48 89 c6             	mov    %rax,%rsi
  805668:	bf 00 00 00 00       	mov    $0x0,%edi
  80566d:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  805674:	00 00 00 
  805677:	ff d0                	callq  *%rax
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  805682:	48 83 ec 40          	sub    $0x40,%rsp
  805686:	89 7d dc             	mov    %edi,-0x24(%rbp)
  805689:	48 89 75 d0          	mov    %rsi,-0x30(%rbp)
  80568d:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
	int r;
	struct Dev *dev;
	struct Fd *fd;
	//cprintf("Inside Read");
	if ((r = fd_lookup(fdnum, &fd)) < 0
  805691:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
  805695:	8b 45 dc             	mov    -0x24(%rbp),%eax
  805698:	48 89 d6             	mov    %rdx,%rsi
  80569b:	89 c7                	mov    %eax,%edi
  80569d:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  8056a4:	00 00 00 
  8056a7:	ff d0                	callq  *%rax
  8056a9:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8056ac:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8056b0:	78 24                	js     8056d6 <read+0x58>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  8056b2:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8056b6:	8b 00                	mov    (%rax),%eax
  8056b8:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  8056bc:	48 89 d6             	mov    %rdx,%rsi
  8056bf:	89 c7                	mov    %eax,%edi
  8056c1:	48 b8 a5 53 80 00 00 	movabs $0x8053a5,%rax
  8056c8:	00 00 00 
  8056cb:	ff d0                	callq  *%rax
  8056cd:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8056d0:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8056d4:	79 05                	jns    8056db <read+0x5d>
		return r;
  8056d6:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8056d9:	eb 76                	jmp    805751 <read+0xd3>
	if ((fd->fd_omode & O_ACCMODE) == O_WRONLY) {
  8056db:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8056df:	8b 40 08             	mov    0x8(%rax),%eax
  8056e2:	83 e0 03             	and    $0x3,%eax
  8056e5:	83 f8 01             	cmp    $0x1,%eax
  8056e8:	75 3a                	jne    805724 <read+0xa6>
  ...
  805702:	48 bf cf 7e 80 00 00 	movabs $0x807ecf,%rdi
  805709:	00 00 00 
  80570c:	b8 00 00 00 00       	mov    $0x0,%eax
  805711:	48 b9 1f 36 80 00 00 	movabs $0x80361f,%rcx
  805718:	00 00 00 
  80571b:	ff d1                	callq  *%rcx
		return -E_INVAL;
  80571d:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  805722:	eb 2d                	jmp    805751 <read+0xd3>
	}
	if (!dev->dev_read)
  805724:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805728:	48 8b 40 10          	mov    0x10(%rax),%rax
  80572c:	48 85 c0             	test   %rax,%rax
  80572f:	75 07                	jne    805738 <read+0xba>
		return -E_NOT_SUPP;
  805731:	b8 f0 ff ff ff       	mov    $0xfffffff0,%eax
  805736:	eb 19                	jmp    805751 <read+0xd3>
	return (*dev->dev_read)(fd, buf, n);
  805738:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  80573c:	48 8b 40 10          	mov    0x10(%rax),%rax
...
readn(int fdnum, void *buf, size_t n)
{
  ...
  805757:	48 83 ec 30          	sub    $0x30,%rsp
  80575b:	89 7d ec             	mov    %edi,-0x14(%rbp)
  80575e:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  805762:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	int m, tot;

	for (tot = 0; tot < n; tot += m) {
  805766:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  80576d:	eb 49                	jmp    8057b8 <readn+0x65>
		m = read(fdnum, (char*)buf + tot, n - tot);
  80576f:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805772:	48 98                	cltq   
  805774:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
  805778:	48 29 c2             	sub    %rax,%rdx
  80577b:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80577e:	48 63 c8             	movslq %eax,%rcx
  805781:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805785:	48 01 c1             	add    %rax,%rcx
  805788:	8b 45 ec             	mov    -0x14(%rbp),%eax
  80578b:	48 89 ce             	mov    %rcx,%rsi
  80578e:	89 c7                	mov    %eax,%edi
  805790:	48 b8 7e 56 80 00 00 	movabs $0x80567e,%rax
  805797:	00 00 00 
  80579a:	ff d0                	callq  *%rax
  80579c:	89 45 f8             	mov    %eax,-0x8(%rbp)
		if (m < 0)
  80579f:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
  8057a3:	79 05                	jns    8057aa <readn+0x57>
			return m;
  8057a5:	8b 45 f8             	mov    -0x8(%rbp),%eax
  8057a8:	eb 1c                	jmp    8057c6 <readn+0x73>
		if (m == 0)
  8057aa:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
  8057ae:	75 02                	jne    8057b2 <readn+0x5f>
			break;
  8057b0:	eb 11                	jmp    8057c3 <readn+0x70>
ssize_t
readn(int fdnum, void *buf, size_t n)
{
	int m, tot;
	...
	for (tot = 0; tot < n; tot += m) {
  8057b2:	8b 45 f8             	mov    -0x8(%rbp),%eax
  8057b5:	01 45 fc             	add    %eax,-0x4(%rbp)
  8057b8:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8057bb:	48 98                	cltq   
  8057bd:	48 3b 45 d8          	cmp    -0x28(%rbp),%rax
  8057c1:	72 ac                	jb     80576f <readn+0x1c>
		if (m < 0)
			return m;
		if (m == 0)
			break;
	...
	return tot;
  8057c3:	8b 45 fc             	mov    -0x4(%rbp),%eax
}
  8057c6:	c9                   	leaveq 
  8057c7:	c3                   	retq   

00000000008057c8 <write>:

ssize_t
write(int fdnum, const void *buf, size_t n)
{
  8057c8:	55                   	push   %rbp
  8057c9:	48 89 e5             	mov    %rsp,%rbp
  8057cc:	48 83 ec 40          	sub    $0x40,%rsp
  8057d0:	89 7d dc             	mov    %edi,-0x24(%rbp)
  8057d3:	48 89 75 d0          	mov    %rsi,-0x30(%rbp)
  8057d7:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
	int r;
	struct Dev *dev;
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
  8057db:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
  8057df:	8b 45 dc             	mov    -0x24(%rbp),%eax
  8057e2:	48 89 d6             	mov    %rdx,%rsi
  8057e5:	89 c7                	mov    %eax,%edi
  8057e7:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  8057ee:	00 00 00 
  8057f1:	ff d0                	callq  *%rax
  8057f3:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8057f6:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8057fa:	78 24                	js     805820 <write+0x58>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  8057fc:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805800:	8b 00                	mov    (%rax),%eax
  805802:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  805806:	48 89 d6             	mov    %rdx,%rsi
  805809:	89 c7                	mov    %eax,%edi
  80580b:	48 b8 a5 53 80 00 00 	movabs $0x8053a5,%rax
  805812:	00 00 00 
  805815:	ff d0                	callq  *%rax
  805817:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80581a:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80581e:	79 05                	jns    805825 <write+0x5d>
		return r;
  805820:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805823:	eb 75                	jmp    80589a <write+0xd2>
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
  805825:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805829:	8b 40 08             	mov    0x8(%rax),%eax
  80582c:	83 e0 03             	and    $0x3,%eax
  80582f:	85 c0                	test   %eax,%eax
  805831:	75 3a                	jne    80586d <write+0xa5>
		cprintf("[%08x] write %d -- bad mode\n", thisenv->env_id, fdnum);
  805833:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  80583a:	00 00 00 
  80583d:	48 8b 00             	mov    (%rax),%rax
  805840:	8b 80 c8 00 00 00    	mov    0xc8(%rax),%eax
  805846:	8b 55 dc             	mov    -0x24(%rbp),%edx
  805849:	89 c6                	mov    %eax,%esi
  80584b:	48 bf eb 7e 80 00 00 	movabs $0x807eeb,%rdi
  805852:	00 00 00 
  805855:	b8 00 00 00 00       	mov    $0x0,%eax
  80585a:	48 b9 1f 36 80 00 00 	movabs $0x80361f,%rcx
  805861:	00 00 00 
  805864:	ff d1                	callq  *%rcx
		return -E_INVAL;
  805866:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  80586b:	eb 2d                	jmp    80589a <write+0xd2>
	{
	...
	if (!dev->dev_write)
  80586d:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805871:	48 8b 40 18          	mov    0x18(%rax),%rax
  805875:	48 85 c0             	test   %rax,%rax
  805878:	75 07                	jne    805881 <write+0xb9>
		return -E_NOT_SUPP;
  80587a:	b8 f0 ff ff ff       	mov    $0xfffffff0,%eax
  80587f:	eb 19                	jmp    80589a <write+0xd2>
	return (*dev->dev_write)(fd, buf, n);
  805881:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805885:	48 8b 40 18          	mov    0x18(%rax),%rax
  805889:	48 8b 4d e8          	mov    -0x18(%rbp),%rcx
  80588d:	48 8b 55 c8          	mov    -0x38(%rbp),%rdx
  805891:	48 8b 75 d0          	mov    -0x30(%rbp),%rsi
  805895:	48 89 cf             	mov    %rcx,%rdi
  805898:	ff d0                	callq  *%rax
}
  80589a:	c9                   	leaveq 
  80589b:	c3                   	retq   

000000000080589c <seek>:

int
seek(int fdnum, off_t offset)
{
  80589c:	55                   	push   %rbp
  80589d:	48 89 e5             	mov    %rsp,%rbp
  8058a0:	48 83 ec 18          	sub    $0x18,%rsp
  8058a4:	89 7d ec             	mov    %edi,-0x14(%rbp)
  8058a7:	89 75 e8             	mov    %esi,-0x18(%rbp)
	int r;
	struct Fd *fd;

	if ((r = fd_lookup(fdnum, &fd)) < 0)
  8058aa:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  8058ae:	8b 45 ec             	mov    -0x14(%rbp),%eax
  8058b1:	48 89 d6             	mov    %rdx,%rsi
  8058b4:	89 c7                	mov    %eax,%edi
  8058b6:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  8058bd:	00 00 00 
  8058c0:	ff d0                	callq  *%rax
  8058c2:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8058c5:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8058c9:	79 05                	jns    8058d0 <seek+0x34>
		return r;
  8058cb:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8058ce:	eb 0f                	jmp    8058df <seek+0x43>
	fd->fd_offset = offset;
  8058d0:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8058d4:	8b 55 e8             	mov    -0x18(%rbp),%edx
  8058d7:	89 50 04             	mov    %edx,0x4(%rax)
	return 0;
  8058da:	b8 00 00 00 00       	mov    $0x0,%eax
}
  8058df:	c9                   	leaveq 
  8058e0:	c3                   	retq   

00000000008058e1 <ftruncate>:
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8058e5:	48 83 ec 30          	sub    $0x30,%rsp
  8058e9:	89 7d dc             	mov    %edi,-0x24(%rbp)
  8058ec:	89 75 d8             	mov    %esi,-0x28(%rbp)
	int r;
	struct Dev *dev;
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
  8058ef:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
  8058f3:	8b 45 dc             	mov    -0x24(%rbp),%eax
  8058f6:	48 89 d6             	mov    %rdx,%rsi
  8058f9:	89 c7                	mov    %eax,%edi
  8058fb:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  805902:	00 00 00 
  805905:	ff d0                	callq  *%rax
  805907:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80590a:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80590e:	78 24                	js     805934 <ftruncate+0x53>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  805910:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805914:	8b 00                	mov    (%rax),%eax
  805916:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  80591a:	48 89 d6             	mov    %rdx,%rsi
  80591d:	89 c7                	mov    %eax,%edi
  80591f:	48 b8 a5 53 80 00 00 	movabs $0x8053a5,%rax
  805926:	00 00 00 
  805929:	ff d0                	callq  *%rax
  80592b:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80592e:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805932:	79 05                	jns    805939 <ftruncate+0x58>
		return r;
  805934:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805937:	eb 72                	jmp    8059ab <ftruncate+0xca>
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
  805939:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  80593d:	8b 40 08             	mov    0x8(%rax),%eax
  805940:	83 e0 03             	and    $0x3,%eax
  805943:	85 c0                	test   %eax,%eax
  805945:	75 3a                	jne    805981 <ftruncate+0xa0>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  805947:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  80594e:	00 00 00 
  805951:	48 8b 00             	mov    (%rax),%rax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
		cprintf("[%08x] ftruncate %d -- bad mode\n",
  805954:	8b 80 c8 00 00 00    	mov    0xc8(%rax),%eax
  80595a:	8b 55 dc             	mov    -0x24(%rbp),%edx
  80595d:	89 c6                	mov    %eax,%esi
  80595f:	48 bf 08 7f 80 00 00 	movabs $0x807f08,%rdi
  805966:	00 00 00 
  805969:	b8 00 00 00 00       	mov    $0x0,%eax
  80596e:	48 b9 1f 36 80 00 00 	movabs $0x80361f,%rcx
  805975:	00 00 00 
  805978:	ff d1                	callq  *%rcx
			thisenv->env_id, fdnum);
		return -E_INVAL;
  80597a:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  80597f:	eb 2a                	jmp    8059ab <ftruncate+0xca>
	}
	if (!dev->dev_trunc)
  805981:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805985:	48 8b 40 30          	mov    0x30(%rax),%rax
  805989:	48 85 c0             	test   %rax,%rax
  80598c:	75 07                	jne    805995 <ftruncate+0xb4>
		return -E_NOT_SUPP;
  80598e:	b8 f0 ff ff ff       	mov    $0xfffffff0,%eax
  805993:	eb 16                	jmp    8059ab <ftruncate+0xca>
	return (*dev->dev_trunc)(fd, newsize);
  805995:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805999:	48 8b 40 30          	mov    0x30(%rax),%rax
  80599d:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
  8059a1:	8b 4d d8             	mov    -0x28(%rbp),%ecx
  8059a4:	89 ce                	mov    %ecx,%esi
  8059a6:	48 89 d7             	mov    %rdx,%rdi
  8059a9:	ff d0                	callq  *%rax
}
  8059ab:	c9                   	leaveq 
  8059ac:	c3                   	retq   

00000000008059ad <fstat>:

int
fstat(int fdnum, struct Stat *stat)
{
  8059ad:	55                   	push   %rbp
  8059ae:	48 89 e5             	mov    %rsp,%rbp
  8059b1:	48 83 ec 30          	sub    $0x30,%rsp
  8059b5:	89 7d dc             	mov    %edi,-0x24(%rbp)
  8059b8:	48 89 75 d0          	mov    %rsi,-0x30(%rbp)
	int r;
	struct Dev *dev;
	struct Fd *fd;

	if ((r = fd_lookup(fdnum, &fd)) < 0
  8059bc:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
  8059c0:	8b 45 dc             	mov    -0x24(%rbp),%eax
  8059c3:	48 89 d6             	mov    %rdx,%rsi
  8059c6:	89 c7                	mov    %eax,%edi
  8059c8:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  8059cf:	00 00 00 
  8059d2:	ff d0                	callq  *%rax
  8059d4:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8059d7:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8059db:	78 24                	js     805a01 <fstat+0x54>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  8059dd:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8059e1:	8b 00                	mov    (%rax),%eax
  8059e3:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  8059e7:	48 89 d6             	mov    %rdx,%rsi
  8059ea:	89 c7                	mov    %eax,%edi
  8059ec:	48 b8 a5 53 80 00 00 	movabs $0x8053a5,%rax
  8059f3:	00 00 00 
  8059f6:	ff d0                	callq  *%rax
  8059f8:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8059fb:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8059ff:	79 05                	jns    805a06 <fstat+0x59>
		return r;
  805a01:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805a04:	eb 5e                	jmp    805a64 <fstat+0xb7>
	if (!dev->dev_stat)
  805a06:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805a0a:	48 8b 40 28          	mov    0x28(%rax),%rax
  805a0e:	48 85 c0             	test   %rax,%rax
  805a11:	75 07                	jne    805a1a <fstat+0x6d>
		return -E_NOT_SUPP;
  805a13:	b8 f0 ff ff ff       	mov    $0xfffffff0,%eax
  805a18:	eb 4a                	jmp    805a64 <fstat+0xb7>
	stat->st_name[0] = 0;
  805a1a:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  805a1e:	c6 00 00             	movb   $0x0,(%rax)
	stat->st_size = 0;
  805a21:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  805a25:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%rax)
  805a2c:	00 00 00 
	stat->st_isdir = 0;
  805a2f:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  805a33:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%rax)
  805a3a:	00 00 00 
	stat->st_dev = dev;
  805a3d:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  805a41:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  805a45:	48 89 90 88 00 00 00 	mov    %rdx,0x88(%rax)
	return (*dev->dev_stat)(fd, stat);
  805a4c:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805a50:	48 8b 40 28          	mov    0x28(%rax),%rax
  805a54:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
  805a58:	48 8b 4d d0          	mov    -0x30(%rbp),%rcx
  805a5c:	48 89 ce             	mov    %rcx,%rsi
  805a5f:	48 89 d7             	mov    %rdx,%rdi
  805a62:	ff d0                	callq  *%rax
}
  805a64:	c9                   	leaveq 
  805a65:	c3                   	retq   

0000000000805a66 <stat>:
...
stat(const char *path, struct Stat *stat)
{
  ...
  805a6a:	48 83 ec 20          	sub    $0x20,%rsp
  805a6e:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  805a72:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
	int fd, r;

	if ((fd = open(path, O_RDONLY)) < 0)
  805a76:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805a7a:	be 00 00 00 00       	mov    $0x0,%esi
  805a7f:	48 89 c7             	mov    %rax,%rdi
  805a82:	48 b8 54 5b 80 00 00 	movabs $0x805b54,%rax
  805a89:	00 00 00 
  805a8c:	ff d0                	callq  *%rax
  805a8e:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805a91:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805a95:	79 05                	jns    805a9c <stat+0x36>
		return fd;
  805a97:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805a9a:	eb 2f                	jmp    805acb <stat+0x65>
	r = fstat(fd, stat);
  805a9c:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
  805aa0:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805aa3:	48 89 d6             	mov    %rdx,%rsi
  805aa6:	89 c7                	mov    %eax,%edi
  805aa8:	48 b8 ad 59 80 00 00 	movabs $0x8059ad,%rax
  805aaf:	00 00 00 
  805ab2:	ff d0                	callq  *%rax
  805ab4:	89 45 f8             	mov    %eax,-0x8(%rbp)
	close(fd);
  805ab7:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805aba:	89 c7                	mov    %eax,%edi
  805abc:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  805ac3:	00 00 00 
  805ac6:	ff d0                	callq  *%rax
	return r;
  805ac8:	8b 45 f8             	mov    -0x8(%rbp),%eax
}
  805acb:	c9                   	leaveq 
  805acc:	c3                   	retq   

0000000000805acd <fsipc>:
...
{
  805acd:	55                   	push   %rbp
  805ace:	48 89 e5             	mov    %rsp,%rbp
  805ad1:	48 83 ec 10          	sub    $0x10,%rsp
  805ad5:	89 7d fc             	mov    %edi,-0x4(%rbp)
  805ad8:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
	static envid_t fsenv;
	if (fsenv == 0)
  805adc:	48 b8 04 30 81 00 00 	movabs $0x813004,%rax
  805ae3:	00 00 00 
  805ae6:	8b 00                	mov    (%rax),%eax
  805ae8:	85 c0                	test   %eax,%eax
  805aea:	75 1d                	jne    805b09 <fsipc+0x3c>
		fsenv = ipc_find_env(ENV_TYPE_FS);
  805aec:	bf 01 00 00 00       	mov    $0x1,%edi
  805af1:	48 b8 e4 50 80 00 00 	movabs $0x8050e4,%rax
  805af8:	00 00 00 
  805afb:	ff d0                	callq  *%rax
  805afd:	48 ba 04 30 81 00 00 	movabs $0x813004,%rdx
  805b04:	00 00 00 
  805b07:	89 02                	mov    %eax,(%rdx)
  ...
  805b09:	48 b8 04 30 81 00 00 	movabs $0x813004,%rax
  805b10:	00 00 00 
  805b13:	8b 00                	mov    (%rax),%eax
  805b15:	8b 75 fc             	mov    -0x4(%rbp),%esi
  805b18:	b9 07 00 00 00       	mov    $0x7,%ecx
  805b1d:	48 ba 00 40 81 00 00 	movabs $0x814000,%rdx
  805b24:	00 00 00 
  805b27:	89 c7                	mov    %eax,%edi
  805b29:	48 b8 82 50 80 00 00 	movabs $0x805082,%rax
  805b30:	00 00 00 
  805b33:	ff d0                	callq  *%rax
	return ipc_recv(NULL, dstva, NULL);
  805b35:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  805b39:	ba 00 00 00 00       	mov    $0x0,%edx
  805b3e:	48 89 c6             	mov    %rax,%rsi
  805b41:	bf 00 00 00 00       	mov    $0x0,%edi
  805b46:	48 b8 7c 4f 80 00 00 	movabs $0x804f7c,%rax
  805b4d:	00 00 00 
...
{
  805b54:	55                   	push   %rbp
  805b55:	48 89 e5             	mov    %rsp,%rbp
  805b58:	48 83 ec 30          	sub    $0x30,%rsp
  805b5c:	48 89 7d d8          	mov    %rdi,-0x28(%rbp)
  805b60:	89 75 d4             	mov    %esi,-0x2c(%rbp)
	...
	// LAB 5: Your code here
	int r = -1;
  805b63:	c7 45 fc ff ff ff ff 	movl   $0xffffffff,-0x4(%rbp)
	int d = -1;
  805b6a:	c7 45 f8 ff ff ff ff 	movl   $0xffffffff,-0x8(%rbp)
	int len = 0;
  805b71:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
	void *va;
	if(!path)
  805b78:	48 83 7d d8 00       	cmpq   $0x0,-0x28(%rbp)
  805b7d:	75 08                	jne    805b87 <open+0x33>
	{
		return r;
  805b7f:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805b82:	e9 f2 00 00 00       	jmpq   805c79 <open+0x125>
	}	
	else if((len = strlen(path)) >= MAXPATHLEN) 
  805b87:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  805b8b:	48 89 c7             	mov    %rax,%rdi
  805b8e:	48 b8 68 41 80 00 00 	movabs $0x804168,%rax
  805b95:	00 00 00 
  805b98:	ff d0                	callq  *%rax
  805b9a:	89 45 f4             	mov    %eax,-0xc(%rbp)
  805b9d:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%rbp)
  805ba4:	7e 0a                	jle    805bb0 <open+0x5c>
	{
		return -E_BAD_PATH;
  805ba6:	b8 f3 ff ff ff       	mov    $0xfffffff3,%eax
  805bab:	e9 c9 00 00 00       	jmpq   805c79 <open+0x125>
	}
	else
	{
		struct Fd *fd_store = NULL;
  805bb0:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
  805bb7:	00 
		if((r = fd_alloc(&fd_store)) < 0 || fd_store == NULL)
  805bb8:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
  805bbc:	48 89 c7             	mov    %rax,%rdi
  805bbf:	48 b8 b4 51 80 00 00 	movabs $0x8051b4,%rax
  805bc6:	00 00 00 
  805bc9:	ff d0                	callq  *%rax
  805bcb:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805bce:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805bd2:	78 09                	js     805bdd <open+0x89>
  805bd4:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805bd8:	48 85 c0             	test   %rax,%rax
  805bdb:	75 08                	jne    805be5 <open+0x91>
		{
			return r;
  805bdd:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805be0:	e9 94 00 00 00       	jmpq   805c79 <open+0x125>
		}	
		strncpy(fsipcbuf.open.req_path,  path, MAXPATHLEN);
  805be5:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  805be9:	ba 00 04 00 00       	mov    $0x400,%edx
  805bee:	48 89 c6             	mov    %rax,%rsi
  805bf1:	48 bf 00 40 81 00 00 	movabs $0x814000,%rdi
  805bf8:	00 00 00 
  805bfb:	48 b8 66 42 80 00 00 	movabs $0x804266,%rax
  805c02:	00 00 00 
  805c05:	ff d0                	callq  *%rax
		fsipcbuf.open.req_omode = mode;
  805c07:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805c0e:	00 00 00 
  805c11:	8b 55 d4             	mov    -0x2c(%rbp),%edx
  805c14:	89 90 00 04 00 00    	mov    %edx,0x400(%rax)
		if ((r = fsipc(FSREQ_OPEN, fd_store)) < 0)
  805c1a:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805c1e:	48 89 c6             	mov    %rax,%rsi
  805c21:	bf 01 00 00 00       	mov    $0x1,%edi
  805c26:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805c2d:	00 00 00 
  805c30:	ff d0                	callq  *%rax
  805c32:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805c35:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805c39:	79 2b                	jns    805c66 <open+0x112>
		{
			if((d = fd_close(fd_store, 0)) < 0)
  805c3b:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805c3f:	be 00 00 00 00       	mov    $0x0,%esi
  805c44:	48 89 c7             	mov    %rax,%rdi
  805c47:	48 b8 dc 52 80 00 00 	movabs $0x8052dc,%rax
  805c4e:	00 00 00 
  805c51:	ff d0                	callq  *%rax
  805c53:	89 45 f8             	mov    %eax,-0x8(%rbp)
  805c56:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
  805c5a:	79 05                	jns    805c61 <open+0x10d>
			{
				return d;
  805c5c:	8b 45 f8             	mov    -0x8(%rbp),%eax
  805c5f:	eb 18                	jmp    805c79 <open+0x125>
			}
			return r;
  805c61:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805c64:	eb 13                	jmp    805c79 <open+0x125>
		}	
		return fd2num(fd_store);
  805c66:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805c6a:	48 89 c7             	mov    %rax,%rdi
  805c6d:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  805c74:	00 00 00 
  805c77:	ff d0                	callq  *%rax
	}
...
0000000000805c7b <devfile_flush>:
...
{
  805c7b:	55                   	push   %rbp
  805c7c:	48 89 e5             	mov    %rsp,%rbp
  805c7f:	48 83 ec 10          	sub    $0x10,%rsp
  805c83:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	fsipcbuf.flush.req_fileid = fd->fd_file.id;
  805c87:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  805c8b:	8b 50 0c             	mov    0xc(%rax),%edx
  805c8e:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805c95:	00 00 00 
  805c98:	89 10                	mov    %edx,(%rax)
	return fsipc(FSREQ_FLUSH, NULL);
  805c9a:	be 00 00 00 00       	mov    $0x0,%esi
  805c9f:	bf 06 00 00 00       	mov    $0x6,%edi
  805ca4:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805cab:	00 00 00 
  805cae:	ff d0                	callq  *%rax
}
  805cb0:	c9                   	leaveq 
  805cb1:	c3                   	retq   

0000000000805cb2 <devfile_read>:
// Returns:
...
{
  805cb2:	55                   	push   %rbp
  805cb3:	48 89 e5             	mov    %rsp,%rbp
  805cb6:	48 83 ec 30          	sub    $0x30,%rsp
  805cba:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  805cbe:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  805cc2:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	...
	// LAB 5: Your code here
	int r = 0;
  805cc6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
	if(!fd || !buf)
  805ccd:	48 83 7d e8 00       	cmpq   $0x0,-0x18(%rbp)
  805cd2:	74 07                	je     805cdb <devfile_read+0x29>
  805cd4:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
  805cd9:	75 07                	jne    805ce2 <devfile_read+0x30>
		return -E_INVAL;
  805cdb:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  805ce0:	eb 77                	jmp    805d59 <devfile_read+0xa7>
  ...
  805cf5:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805cfc:	00 00 00 
  805cff:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
  805d03:	48 89 50 08          	mov    %rdx,0x8(%rax)
	if ((r = fsipc(FSREQ_READ, NULL)) <= 0){
  805d07:	be 00 00 00 00       	mov    $0x0,%esi
  805d0c:	bf 03 00 00 00       	mov    $0x3,%edi
  805d11:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805d18:	00 00 00 
  805d1b:	ff d0                	callq  *%rax
  805d1d:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805d20:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805d24:	7f 05                	jg     805d2b <devfile_read+0x79>
		//cprintf("devfile_read r is [%d]\n",r);
		return r;
  805d26:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805d29:	eb 2e                	jmp    805d59 <devfile_read+0xa7>
	}
	//cprintf("devfile_read %x %x %x %x\n",fsipcbuf.readRet.ret_buf[0], fsipcbuf.readRet.ret_buf[1], fsipcbuf.readRet.ret_buf[2], fsipcbuf.readRet.ret_buf[3]);
	memmove(buf, (char*)fsipcbuf.readRet.ret_buf, r);
  805d2b:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805d2e:	48 63 d0             	movslq %eax,%rdx
  805d31:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805d35:	48 be 00 40 81 00 00 	movabs $0x814000,%rsi
  805d3c:	00 00 00 
  805d3f:	48 89 c7             	mov    %rax,%rdi
  805d42:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  805d49:	00 00 00 
  805d4c:	ff d0                	callq  *%rax
	char* buf1 = (char*)buf;
  805d4e:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805d52:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
	//cprintf("devfile_read ri is [%d] %x %x %x %x\n",r,buf1[0],buf1[1],buf1[2],buf1[3]);
	return r;
  805d56:	8b 45 fc             	mov    -0x4(%rbp),%eax
	//panic("devfile_read not implemented");
}
  805d59:	c9                   	leaveq 
  805d5a:	c3                   	retq   

0000000000805d5b <devfile_write>:
// Returns:
...
{
  805d5b:	55                   	push   %rbp
  805d5c:	48 89 e5             	mov    %rsp,%rbp
  805d5f:	48 83 ec 30          	sub    $0x30,%rsp
  805d63:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  805d67:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  805d6b:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	...
	// LAB 5: Your code here
	int r = -1;
  805d6f:	c7 45 fc ff ff ff ff 	movl   $0xffffffff,-0x4(%rbp)
	if(!fd || !buf)
  805d76:	48 83 7d e8 00       	cmpq   $0x0,-0x18(%rbp)
  805d7b:	74 07                	je     805d84 <devfile_write+0x29>
  805d7d:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
  805d82:	75 08                	jne    805d8c <devfile_write+0x31>
		return r;
  805d84:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805d87:	e9 9a 00 00 00       	jmpq   805e26 <devfile_write+0xcb>
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  805d8c:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805d90:	8b 50 0c             	mov    0xc(%rax),%edx
  805d93:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805d9a:	00 00 00 
  805d9d:	89 10                	mov    %edx,(%rax)
	if(n > PGSIZE - (sizeof(int) + sizeof(size_t)))
  805d9f:	48 81 7d d8 f4 0f 00 	cmpq   $0xff4,-0x28(%rbp)
  805da6:	00 
  805da7:	76 08                	jbe    805db1 <devfile_write+0x56>
	{
		n = PGSIZE - (sizeof(int) + sizeof(size_t));
  805da9:	48 c7 45 d8 f4 0f 00 	movq   $0xff4,-0x28(%rbp)
  805db0:	00 
	}
	fsipcbuf.write.req_n = n;
  805db1:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805db8:	00 00 00 
  805dbb:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
  805dbf:	48 89 50 08          	mov    %rdx,0x8(%rax)
	
	memmove((void*)fsipcbuf.write.req_buf, (void*)buf, n);
  805dc3:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
  805dc7:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805dcb:	48 89 c6             	mov    %rax,%rsi
  805dce:	48 bf 10 40 81 00 00 	movabs $0x814010,%rdi
  805dd5:	00 00 00 
  805dd8:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  805ddf:	00 00 00 
  805de2:	ff d0                	callq  *%rax
	if ((r = fsipc(FSREQ_WRITE, NULL)) <= 0){
  805de4:	be 00 00 00 00       	mov    $0x0,%esi
  805de9:	bf 04 00 00 00       	mov    $0x4,%edi
  805dee:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805df5:	00 00 00 
  805df8:	ff d0                	callq  *%rax
  805dfa:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805dfd:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805e01:	7f 20                	jg     805e23 <devfile_write+0xc8>
		cprintf("fsipc-FSREQ_WRITE returns 0");
  805e03:	48 bf 2e 7f 80 00 00 	movabs $0x807f2e,%rdi
  805e0a:	00 00 00 
  805e0d:	b8 00 00 00 00       	mov    $0x0,%eax
  805e12:	48 ba 1f 36 80 00 00 	movabs $0x80361f,%rdx
  805e19:	00 00 00 
  805e1c:	ff d2                	callq  *%rdx
		return r;
  805e1e:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805e21:	eb 03                	jmp    805e26 <devfile_write+0xcb>
	}
	return r;
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  805e2c:	48 83 ec 20          	sub    $0x20,%rsp
  805e30:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  805e34:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
	int r;

	fsipcbuf.stat.req_fileid = fd->fd_file.id;
  805e38:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  805e3c:	8b 50 0c             	mov    0xc(%rax),%edx
  805e3f:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805e46:	00 00 00 
  805e49:	89 10                	mov    %edx,(%rax)
	if ((r = fsipc(FSREQ_STAT, NULL)) < 0)
  805e4b:	be 00 00 00 00       	mov    $0x0,%esi
  805e50:	bf 05 00 00 00       	mov    $0x5,%edi
  805e55:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805e5c:	00 00 00 
  805e5f:	ff d0                	callq  *%rax
  805e61:	89 45 fc             	mov    %eax,-0x4(%rbp)
  805e64:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805e68:	79 05                	jns    805e6f <devfile_stat+0x47>
		return r;
  805e6a:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805e6d:	eb 56                	jmp    805ec5 <devfile_stat+0x9d>
	strcpy(st->st_name, fsipcbuf.statRet.ret_name);
  805e6f:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805e73:	48 be 00 40 81 00 00 	movabs $0x814000,%rsi
  805e7a:	00 00 00 
  805e7d:	48 89 c7             	mov    %rax,%rdi
  805e80:	48 b8 d4 41 80 00 00 	movabs $0x8041d4,%rax
  805e87:	00 00 00 
  805e8a:	ff d0                	callq  *%rax
	st->st_size = fsipcbuf.statRet.ret_size;
  805e8c:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805e93:	00 00 00 
  805e96:	8b 90 80 00 00 00    	mov    0x80(%rax),%edx
  805e9c:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805ea0:	89 90 80 00 00 00    	mov    %edx,0x80(%rax)
	st->st_isdir = fsipcbuf.statRet.ret_isdir;
  805ea6:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805ead:	00 00 00 
  805eb0:	8b 90 84 00 00 00    	mov    0x84(%rax),%edx
  805eb6:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  805eba:	89 90 84 00 00 00    	mov    %edx,0x84(%rax)
	return 0;
  805ec0:	b8 00 00 00 00       	mov    $0x0,%eax
}
  805ec5:	c9                   	leaveq 
  805ec6:	c3                   	retq   

0000000000805ec7 <devfile_trunc>:
...
{
  805ec7:	55                   	push   %rbp
  805ec8:	48 89 e5             	mov    %rsp,%rbp
  805ecb:	48 83 ec 10          	sub    $0x10,%rsp
  805ecf:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  805ed3:	89 75 f4             	mov    %esi,-0xc(%rbp)
	fsipcbuf.set_size.req_fileid = fd->fd_file.id;
  805ed6:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  805eda:	8b 50 0c             	mov    0xc(%rax),%edx
  805edd:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805ee4:	00 00 00 
  805ee7:	89 10                	mov    %edx,(%rax)
	fsipcbuf.set_size.req_size = newsize;
  805ee9:	48 b8 00 40 81 00 00 	movabs $0x814000,%rax
  805ef0:	00 00 00 
  805ef3:	8b 55 f4             	mov    -0xc(%rbp),%edx
  805ef6:	89 50 04             	mov    %edx,0x4(%rax)
	return fsipc(FSREQ_SET_SIZE, NULL);
  805ef9:	be 00 00 00 00       	mov    $0x0,%esi
  805efe:	bf 02 00 00 00       	mov    $0x2,%edi
  805f03:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805f0a:	00 00 00 
  805f0d:	ff d0                	callq  *%rax
}
  805f0f:	c9                   	leaveq 
  805f10:	c3                   	retq   

0000000000805f11 <remove>:
...
{
  805f11:	55                   	push   %rbp
  805f12:	48 89 e5             	mov    %rsp,%rbp
  805f15:	48 83 ec 10          	sub    $0x10,%rsp
  805f19:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	if (strlen(path) >= MAXPATHLEN)
  805f1d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  805f21:	48 89 c7             	mov    %rax,%rdi
  805f24:	48 b8 68 41 80 00 00 	movabs $0x804168,%rax
  805f2b:	00 00 00 
  805f2e:	ff d0                	callq  *%rax
  805f30:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  805f35:	7e 07                	jle    805f3e <remove+0x2d>
		return -E_BAD_PATH;
  805f37:	b8 f3 ff ff ff       	mov    $0xfffffff3,%eax
  805f3c:	eb 33                	jmp    805f71 <remove+0x60>
	strcpy(fsipcbuf.remove.req_path, path);
  805f3e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  805f42:	48 89 c6             	mov    %rax,%rsi
  805f45:	48 bf 00 40 81 00 00 	movabs $0x814000,%rdi
  805f4c:	00 00 00 
  805f4f:	48 b8 d4 41 80 00 00 	movabs $0x8041d4,%rax
  805f56:	00 00 00 
  805f59:	ff d0                	callq  *%rax
	return fsipc(FSREQ_REMOVE, NULL);
  805f5b:	be 00 00 00 00       	mov    $0x0,%esi
  805f60:	bf 07 00 00 00       	mov    $0x7,%edi
  805f65:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805f6c:	00 00 00 
  805f6f:	ff d0                	callq  *%rax
}
  805f71:	c9                   	leaveq 
  805f72:	c3                   	retq   

0000000000805f73 <sync>:
...
{
  805f73:	55                   	push   %rbp
  805f74:	48 89 e5             	mov    %rsp,%rbp
	// Ask the file server to update the disk
	// by writing any dirty blocks in the buffer cache.

	return fsipc(FSREQ_SYNC, NULL);
  805f77:	be 00 00 00 00       	mov    $0x0,%esi
  805f7c:	bf 08 00 00 00       	mov    $0x8,%edi
  805f81:	48 b8 cd 5a 80 00 00 	movabs $0x805acd,%rax
  805f88:	00 00 00 
...
{
  805f8f:	55                   	push   %rbp
  805f90:	48 89 e5             	mov    %rsp,%rbp
  805f93:	48 81 ec 20 02 00 00 	sub    $0x220,%rsp
  805f9a:	48 89 bd e8 fd ff ff 	mov    %rdi,-0x218(%rbp)
  805fa1:	48 89 b5 e0 fd ff ff 	mov    %rsi,-0x220(%rbp)
	int r;
	int fd_src, fd_dest;
  ...
  805fa8:	48 8b 85 e8 fd ff ff 	mov    -0x218(%rbp),%rax
  805faf:	be 00 00 00 00       	mov    $0x0,%esi
  805fb4:	48 89 c7             	mov    %rax,%rdi
  805fb7:	48 b8 54 5b 80 00 00 	movabs $0x805b54,%rax
  805fbe:	00 00 00 
  805fc1:	ff d0                	callq  *%rax
  805fc3:	89 45 fc             	mov    %eax,-0x4(%rbp)
	if (fd_src < 0) {	//error
  805fc6:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  805fca:	79 28                	jns    805ff4 <copy+0x65>
		cprintf("cp open src error:%e\n", fd_src);
  805fcc:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805fcf:	89 c6                	mov    %eax,%esi
  805fd1:	48 bf 4a 7f 80 00 00 	movabs $0x807f4a,%rdi
  805fd8:	00 00 00 
  805fdb:	b8 00 00 00 00       	mov    $0x0,%eax
  805fe0:	48 ba 1f 36 80 00 00 	movabs $0x80361f,%rdx
  805fe7:	00 00 00 
  805fea:	ff d2                	callq  *%rdx
		return fd_src;
  805fec:	8b 45 fc             	mov    -0x4(%rbp),%eax
  805fef:	e9 74 01 00 00       	jmpq   806168 <copy+0x1d9>
	}
	
	fd_dest = open(dest, O_CREAT | O_WRONLY);
  805ff4:	48 8b 85 e0 fd ff ff 	mov    -0x220(%rbp),%rax
  805ffb:	be 01 01 00 00       	mov    $0x101,%esi
  806000:	48 89 c7             	mov    %rax,%rdi
  806003:	48 b8 54 5b 80 00 00 	movabs $0x805b54,%rax
  80600a:	00 00 00 
  80600d:	ff d0                	callq  *%rax
  80600f:	89 45 f8             	mov    %eax,-0x8(%rbp)
	if (fd_dest < 0) {	//error
  806012:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
  806016:	79 39                	jns    806051 <copy+0xc2>
		cprintf("cp create dest  error:%e\n", fd_dest);
  806018:	8b 45 f8             	mov    -0x8(%rbp),%eax
  80601b:	89 c6                	mov    %eax,%esi
  80601d:	48 bf 60 7f 80 00 00 	movabs $0x807f60,%rdi
  806024:	00 00 00 
  806027:	b8 00 00 00 00       	mov    $0x0,%eax
  80602c:	48 ba 1f 36 80 00 00 	movabs $0x80361f,%rdx
  806033:	00 00 00 
  806036:	ff d2                	callq  *%rdx
		close(fd_src);
  806038:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80603b:	89 c7                	mov    %eax,%edi
  80603d:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  806044:	00 00 00 
  806047:	ff d0                	callq  *%rax
		return fd_dest;
  806049:	8b 45 f8             	mov    -0x8(%rbp),%eax
  80604c:	e9 17 01 00 00       	jmpq   806168 <copy+0x1d9>
	}
	
	while ((read_size = read(fd_src, buffer, 512)) > 0) {
  806051:	eb 74                	jmp    8060c7 <copy+0x138>
		write_size = write(fd_dest, buffer, read_size);
  806053:	8b 45 f4             	mov    -0xc(%rbp),%eax
  806056:	48 63 d0             	movslq %eax,%rdx
  806059:	48 8d 8d f0 fd ff ff 	lea    -0x210(%rbp),%rcx
  806060:	8b 45 f8             	mov    -0x8(%rbp),%eax
  806063:	48 89 ce             	mov    %rcx,%rsi
  806066:	89 c7                	mov    %eax,%edi
  806068:	48 b8 c8 57 80 00 00 	movabs $0x8057c8,%rax
  80606f:	00 00 00 
  806072:	ff d0                	callq  *%rax
  806074:	89 45 f0             	mov    %eax,-0x10(%rbp)
		if (write_size < 0) {
  806077:	83 7d f0 00          	cmpl   $0x0,-0x10(%rbp)
  80607b:	79 4a                	jns    8060c7 <copy+0x138>
			cprintf("cp write error:%e\n", write_size);
  80607d:	8b 45 f0             	mov    -0x10(%rbp),%eax
  806080:	89 c6                	mov    %eax,%esi
  806082:	48 bf 7a 7f 80 00 00 	movabs $0x807f7a,%rdi
  806089:	00 00 00 
  80608c:	b8 00 00 00 00       	mov    $0x0,%eax
  806091:	48 ba 1f 36 80 00 00 	movabs $0x80361f,%rdx
  806098:	00 00 00 
  80609b:	ff d2                	callq  *%rdx
			close(fd_src);
  80609d:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8060a0:	89 c7                	mov    %eax,%edi
  8060a2:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  8060a9:	00 00 00 
  8060ac:	ff d0                	callq  *%rax
			close(fd_dest);
  8060ae:	8b 45 f8             	mov    -0x8(%rbp),%eax
  8060b1:	89 c7                	mov    %eax,%edi
  8060b3:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  8060ba:	00 00 00 
  8060bd:	ff d0                	callq  *%rax
			return write_size;
  8060bf:	8b 45 f0             	mov    -0x10(%rbp),%eax
  8060c2:	e9 a1 00 00 00       	jmpq   806168 <copy+0x1d9>
		cprintf("cp create dest  error:%e\n", fd_dest);
		close(fd_src);
		return fd_dest;
	}
	...
	while ((read_size = read(fd_src, buffer, 512)) > 0) {
  8060c7:	48 8d 8d f0 fd ff ff 	lea    -0x210(%rbp),%rcx
  8060ce:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8060d1:	ba 00 02 00 00       	mov    $0x200,%edx
  8060d6:	48 89 ce             	mov    %rcx,%rsi
  8060d9:	89 c7                	mov    %eax,%edi
  8060db:	48 b8 7e 56 80 00 00 	movabs $0x80567e,%rax
  8060e2:	00 00 00 
  8060e5:	ff d0                	callq  *%rax
  8060e7:	89 45 f4             	mov    %eax,-0xc(%rbp)
  8060ea:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
  8060ee:	0f 8f 5f ff ff ff    	jg     806053 <copy+0xc4>
			close(fd_src);
			close(fd_dest);
			return write_size;
		}		
	...
	if (read_size < 0) {
  8060f4:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
  8060f8:	79 47                	jns    806141 <copy+0x1b2>
		cprintf("cp read src error:%e\n", read_size);
  8060fa:	8b 45 f4             	mov    -0xc(%rbp),%eax
  8060fd:	89 c6                	mov    %eax,%esi
  8060ff:	48 bf 8d 7f 80 00 00 	movabs $0x807f8d,%rdi
  806106:	00 00 00 
  806109:	b8 00 00 00 00       	mov    $0x0,%eax
  80610e:	48 ba 1f 36 80 00 00 	movabs $0x80361f,%rdx
  806115:	00 00 00 
  806118:	ff d2                	callq  *%rdx
		close(fd_src);
  80611a:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80611d:	89 c7                	mov    %eax,%edi
  80611f:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  806126:	00 00 00 
  806129:	ff d0                	callq  *%rax
		close(fd_dest);
  80612b:	8b 45 f8             	mov    -0x8(%rbp),%eax
  80612e:	89 c7                	mov    %eax,%edi
  806130:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  806137:	00 00 00 
  80613a:	ff d0                	callq  *%rax
		return read_size;
  80613c:	8b 45 f4             	mov    -0xc(%rbp),%eax
  80613f:	eb 27                	jmp    806168 <copy+0x1d9>
	}
	close(fd_src);
  806141:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806144:	89 c7                	mov    %eax,%edi
  806146:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  80614d:	00 00 00 
  806150:	ff d0                	callq  *%rax
	close(fd_dest);
  806152:	8b 45 f8             	mov    -0x8(%rbp),%eax
  806155:	89 c7                	mov    %eax,%edi
  806157:	48 b8 5c 54 80 00 00 	movabs $0x80545c,%rax
  80615e:	00 00 00 
  806161:	ff d0                	callq  *%rax
	return 0;
  806163:	b8 00 00 00 00       	mov    $0x0,%eax
	
}
  806168:	c9                   	leaveq 
  806169:	c3                   	retq   

000000000080616a <pageref>:
#include <inc/lib.h>
...
{
  80616a:	55                   	push   %rbp
  80616b:	48 89 e5             	mov    %rsp,%rbp
  80616e:	48 83 ec 18          	sub    $0x18,%rsp
  806172:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
	pte_t pte;

	if (!(uvpd[VPD(v)] & PTE_P))
  806176:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  80617a:	48 c1 e8 15          	shr    $0x15,%rax
  80617e:	48 89 c2             	mov    %rax,%rdx
  806181:	48 b8 00 00 00 80 00 	movabs $0x10080000000,%rax
  806188:	01 00 00 
  80618b:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  80618f:	83 e0 01             	and    $0x1,%eax
  806192:	48 85 c0             	test   %rax,%rax
  806195:	75 07                	jne    80619e <pageref+0x34>
		return 0;
  806197:	b8 00 00 00 00       	mov    $0x0,%eax
  80619c:	eb 53                	jmp    8061f1 <pageref+0x87>
	pte = uvpt[PGNUM(v)];
  80619e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8061a2:	48 c1 e8 0c          	shr    $0xc,%rax
  8061a6:	48 89 c2             	mov    %rax,%rdx
  8061a9:	48 b8 00 00 00 00 00 	movabs $0x10000000000,%rax
  8061b0:	01 00 00 
  8061b3:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
  8061b7:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
	if (!(pte & PTE_P))
  8061bb:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  8061bf:	83 e0 01             	and    $0x1,%eax
  8061c2:	48 85 c0             	test   %rax,%rax
  8061c5:	75 07                	jne    8061ce <pageref+0x64>
		return 0;
  8061c7:	b8 00 00 00 00       	mov    $0x0,%eax
  8061cc:	eb 23                	jmp    8061f1 <pageref+0x87>
	return pages[PPN(pte)].pp_ref;
  8061ce:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  8061d2:	48 c1 e8 0c          	shr    $0xc,%rax
  8061d6:	48 89 c2             	mov    %rax,%rdx
  8061d9:	48 b8 00 00 a0 00 80 	movabs $0x8000a00000,%rax
  8061e0:	00 00 00 
  8061e3:	48 c1 e2 04          	shl    $0x4,%rdx
  8061e7:	48 01 d0             	add    %rdx,%rax
  8061ea:	0f b7 40 08          	movzwl 0x8(%rax),%eax
  8061ee:	0f b7 c0             	movzwl %ax,%eax
}
  8061f1:	c9                   	leaveq 
  8061f2:	c3                   	retq   

00000000008061f3 <fd2sockid>:
...
{
  8061f3:	55                   	push   %rbp
  8061f4:	48 89 e5             	mov    %rsp,%rbp
  8061f7:	48 83 ec 20          	sub    $0x20,%rsp
  8061fb:	89 7d ec             	mov    %edi,-0x14(%rbp)
	struct Fd *sfd;
	int r;

	if ((r = fd_lookup(fd, &sfd)) < 0)
  8061fe:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  806202:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806205:	48 89 d6             	mov    %rdx,%rsi
  806208:	89 c7                	mov    %eax,%edi
  80620a:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  806211:	00 00 00 
  806214:	ff d0                	callq  *%rax
  806216:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806219:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80621d:	79 05                	jns    806224 <fd2sockid+0x31>
		return r;
  80621f:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806222:	eb 24                	jmp    806248 <fd2sockid+0x55>
	if (sfd->fd_dev_id != devsock.dev_id)
  806224:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806228:	8b 10                	mov    (%rax),%edx
  80622a:	48 b8 20 21 81 00 00 	movabs $0x812120,%rax
  806231:	00 00 00 
  806234:	8b 00                	mov    (%rax),%eax
  806236:	39 c2                	cmp    %eax,%edx
  806238:	74 07                	je     806241 <fd2sockid+0x4e>
		return -E_NOT_SUPP;
  80623a:	b8 f0 ff ff ff       	mov    $0xfffffff0,%eax
  80623f:	eb 07                	jmp    806248 <fd2sockid+0x55>
	return sfd->fd_sock.sockid;
  806241:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806245:	8b 40 0c             	mov    0xc(%rax),%eax
}
  806248:	c9                   	leaveq 
  806249:	c3                   	retq   

000000000080624a <alloc_sockfd>:

static int
alloc_sockfd(int sockid)
{
  80624a:	55                   	push   %rbp
  80624b:	48 89 e5             	mov    %rsp,%rbp
  80624e:	48 83 ec 20          	sub    $0x20,%rsp
  806252:	89 7d ec             	mov    %edi,-0x14(%rbp)
	struct Fd *sfd;
	int r;

	if ((r = fd_alloc(&sfd)) < 0
  806255:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
  806259:	48 89 c7             	mov    %rax,%rdi
  80625c:	48 b8 b4 51 80 00 00 	movabs $0x8051b4,%rax
  806263:	00 00 00 
  806266:	ff d0                	callq  *%rax
  806268:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80626b:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80626f:	78 26                	js     806297 <alloc_sockfd+0x4d>
            || (r = sys_page_alloc(0, sfd, PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0) {
  806271:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806275:	ba 07 04 00 00       	mov    $0x407,%edx
  80627a:	48 89 c6             	mov    %rax,%rsi
  80627d:	bf 00 00 00 00       	mov    $0x0,%edi
  806282:	48 b8 03 4b 80 00 00 	movabs $0x804b03,%rax
  806289:	00 00 00 
  80628c:	ff d0                	callq  *%rax
  80628e:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806291:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806295:	79 16                	jns    8062ad <alloc_sockfd+0x63>
		nsipc_close(sockid);
  806297:	8b 45 ec             	mov    -0x14(%rbp),%eax
  80629a:	89 c7                	mov    %eax,%edi
  80629c:	48 b8 57 67 80 00 00 	movabs $0x806757,%rax
  8062a3:	00 00 00 
  8062a6:	ff d0                	callq  *%rax
		return r;
  8062a8:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8062ab:	eb 3a                	jmp    8062e7 <alloc_sockfd+0x9d>
	}

	sfd->fd_dev_id = devsock.dev_id;
  8062ad:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8062b1:	48 ba 20 21 81 00 00 	movabs $0x812120,%rdx
  8062b8:	00 00 00 
  8062bb:	8b 12                	mov    (%rdx),%edx
  8062bd:	89 10                	mov    %edx,(%rax)
	sfd->fd_omode = O_RDWR;
  8062bf:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8062c3:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%rax)
	sfd->fd_sock.sockid = sockid;
  8062ca:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8062ce:	8b 55 ec             	mov    -0x14(%rbp),%edx
  8062d1:	89 50 0c             	mov    %edx,0xc(%rax)
	return fd2num(sfd);
  8062d4:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8062d8:	48 89 c7             	mov    %rax,%rdi
  8062db:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  8062e2:	00 00 00 
  8062e5:	ff d0                	callq  *%rax
}
  8062e7:	c9                   	leaveq 
  8062e8:	c3                   	retq   

00000000008062e9 <accept>:

int
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  8062e9:	55                   	push   %rbp
  8062ea:	48 89 e5             	mov    %rsp,%rbp
  8062ed:	48 83 ec 30          	sub    $0x30,%rsp
  8062f1:	89 7d ec             	mov    %edi,-0x14(%rbp)
  8062f4:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  8062f8:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	int r;
	if ((r = fd2sockid(s)) < 0)
  8062fc:	8b 45 ec             	mov    -0x14(%rbp),%eax
  8062ff:	89 c7                	mov    %eax,%edi
  806301:	48 b8 f3 61 80 00 00 	movabs $0x8061f3,%rax
  806308:	00 00 00 
  80630b:	ff d0                	callq  *%rax
  80630d:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806310:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806314:	79 05                	jns    80631b <accept+0x32>
		return r;
  806316:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806319:	eb 3b                	jmp    806356 <accept+0x6d>
	if ((r = nsipc_accept(r, addr, addrlen)) < 0)
  80631b:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
  80631f:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
  806323:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806326:	48 89 ce             	mov    %rcx,%rsi
  806329:	89 c7                	mov    %eax,%edi
  80632b:	48 b8 34 66 80 00 00 	movabs $0x806634,%rax
  806332:	00 00 00 
  806335:	ff d0                	callq  *%rax
  806337:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80633a:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80633e:	79 05                	jns    806345 <accept+0x5c>
		return r;
  806340:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806343:	eb 11                	jmp    806356 <accept+0x6d>
	return alloc_sockfd(r);
  806345:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806348:	89 c7                	mov    %eax,%edi
  80634a:	48 b8 4a 62 80 00 00 	movabs $0x80624a,%rax
  806351:	00 00 00 
...
0000000000806358 <bind>:

int
bind(int s, struct sockaddr *name, socklen_t namelen)
{
  806358:	55                   	push   %rbp
  806359:	48 89 e5             	mov    %rsp,%rbp
  80635c:	48 83 ec 20          	sub    $0x20,%rsp
  806360:	89 7d ec             	mov    %edi,-0x14(%rbp)
  806363:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  806367:	89 55 e8             	mov    %edx,-0x18(%rbp)
	int r;
	if ((r = fd2sockid(s)) < 0)
  80636a:	8b 45 ec             	mov    -0x14(%rbp),%eax
  80636d:	89 c7                	mov    %eax,%edi
  80636f:	48 b8 f3 61 80 00 00 	movabs $0x8061f3,%rax
  806376:	00 00 00 
  806379:	ff d0                	callq  *%rax
  80637b:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80637e:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806382:	79 05                	jns    806389 <bind+0x31>
		return r;
  806384:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806387:	eb 1b                	jmp    8063a4 <bind+0x4c>
	return nsipc_bind(r, name, namelen);
  806389:	8b 55 e8             	mov    -0x18(%rbp),%edx
  80638c:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
  806390:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806393:	48 89 ce             	mov    %rcx,%rsi
  806396:	89 c7                	mov    %eax,%edi
  806398:	48 b8 b3 66 80 00 00 	movabs $0x8066b3,%rax
  80639f:	00 00 00 
...
00000000008063a6 <shutdown>:

int
shutdown(int s, int how)
{
  8063a6:	55                   	push   %rbp
  8063a7:	48 89 e5             	mov    %rsp,%rbp
  8063aa:	48 83 ec 20          	sub    $0x20,%rsp
  8063ae:	89 7d ec             	mov    %edi,-0x14(%rbp)
  8063b1:	89 75 e8             	mov    %esi,-0x18(%rbp)
	int r;
	if ((r = fd2sockid(s)) < 0)
  8063b4:	8b 45 ec             	mov    -0x14(%rbp),%eax
  8063b7:	89 c7                	mov    %eax,%edi
  8063b9:	48 b8 f3 61 80 00 00 	movabs $0x8061f3,%rax
  8063c0:	00 00 00 
  8063c3:	ff d0                	callq  *%rax
  8063c5:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8063c8:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8063cc:	79 05                	jns    8063d3 <shutdown+0x2d>
		return r;
  8063ce:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8063d1:	eb 16                	jmp    8063e9 <shutdown+0x43>
	return nsipc_shutdown(r, how);
  8063d3:	8b 55 e8             	mov    -0x18(%rbp),%edx
  8063d6:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8063d9:	89 d6                	mov    %edx,%esi
  8063db:	89 c7                	mov    %eax,%edi
  8063dd:	48 b8 17 67 80 00 00 	movabs $0x806717,%rax
  8063e4:	00 00 00 
  8063e7:	ff d0                	callq  *%rax
}
  8063e9:	c9                   	leaveq 
  8063ea:	c3                   	retq   

00000000008063eb <devsock_close>:

static int
devsock_close(struct Fd *fd)
{
  8063eb:	55                   	push   %rbp
  8063ec:	48 89 e5             	mov    %rsp,%rbp
  8063ef:	48 83 ec 10          	sub    $0x10,%rsp
  8063f3:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	if (pageref(fd) == 1)
  8063f7:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  8063fb:	48 89 c7             	mov    %rax,%rdi
  8063fe:	48 b8 6a 61 80 00 00 	movabs $0x80616a,%rax
  806405:	00 00 00 
  806408:	ff d0                	callq  *%rax
  80640a:	83 f8 01             	cmp    $0x1,%eax
  80640d:	75 17                	jne    806426 <devsock_close+0x3b>
		return nsipc_close(fd->fd_sock.sockid);
  80640f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806413:	8b 40 0c             	mov    0xc(%rax),%eax
  806416:	89 c7                	mov    %eax,%edi
  806418:	48 b8 57 67 80 00 00 	movabs $0x806757,%rax
  80641f:	00 00 00 
  806422:	ff d0                	callq  *%rax
  806424:	eb 05                	jmp    80642b <devsock_close+0x40>
	else
		return 0;
  806426:	b8 00 00 00 00       	mov    $0x0,%eax
}
  80642b:	c9                   	leaveq 
  80642c:	c3                   	retq   

000000000080642d <connect>:

int
connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  80642d:	55                   	push   %rbp
  80642e:	48 89 e5             	mov    %rsp,%rbp
  806431:	48 83 ec 20          	sub    $0x20,%rsp
  806435:	89 7d ec             	mov    %edi,-0x14(%rbp)
  806438:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  80643c:	89 55 e8             	mov    %edx,-0x18(%rbp)
	int r;
	if ((r = fd2sockid(s)) < 0)
  80643f:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806442:	89 c7                	mov    %eax,%edi
  806444:	48 b8 f3 61 80 00 00 	movabs $0x8061f3,%rax
  80644b:	00 00 00 
  80644e:	ff d0                	callq  *%rax
  806450:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806453:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806457:	79 05                	jns    80645e <connect+0x31>
		return r;
  806459:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80645c:	eb 1b                	jmp    806479 <connect+0x4c>
	return nsipc_connect(r, name, namelen);
  80645e:	8b 55 e8             	mov    -0x18(%rbp),%edx
  806461:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
  806465:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806468:	48 89 ce             	mov    %rcx,%rsi
  80646b:	89 c7                	mov    %eax,%edi
  80646d:	48 b8 84 67 80 00 00 	movabs $0x806784,%rax
  806474:	00 00 00 
  806477:	ff d0                	callq  *%rax
}
  806479:	c9                   	leaveq 
  80647a:	c3                   	retq   

000000000080647b <listen>:

int
listen(int s, int backlog)
{
  80647b:	55                   	push   %rbp
  80647c:	48 89 e5             	mov    %rsp,%rbp
  80647f:	48 83 ec 20          	sub    $0x20,%rsp
  806483:	89 7d ec             	mov    %edi,-0x14(%rbp)
  806486:	89 75 e8             	mov    %esi,-0x18(%rbp)
	int r;
	if ((r = fd2sockid(s)) < 0)
  806489:	8b 45 ec             	mov    -0x14(%rbp),%eax
  80648c:	89 c7                	mov    %eax,%edi
  80648e:	48 b8 f3 61 80 00 00 	movabs $0x8061f3,%rax
  806495:	00 00 00 
  806498:	ff d0                	callq  *%rax
  80649a:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80649d:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8064a1:	79 05                	jns    8064a8 <listen+0x2d>
		return r;
  8064a3:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8064a6:	eb 16                	jmp    8064be <listen+0x43>
	return nsipc_listen(r, backlog);
  8064a8:	8b 55 e8             	mov    -0x18(%rbp),%edx
  8064ab:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8064ae:	89 d6                	mov    %edx,%esi
  8064b0:	89 c7                	mov    %eax,%edi
  8064b2:	48 b8 e8 67 80 00 00 	movabs $0x8067e8,%rax
  8064b9:	00 00 00 
...
devsock_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8064c8:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  8064cc:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
  8064d0:	48 89 55 e8          	mov    %rdx,-0x18(%rbp)
	return nsipc_recv(fd->fd_sock.sockid, buf, n, 0);
  8064d4:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  8064d8:	89 c2                	mov    %eax,%edx
  8064da:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  8064de:	8b 40 0c             	mov    0xc(%rax),%eax
  8064e1:	48 8b 75 f0          	mov    -0x10(%rbp),%rsi
  8064e5:	b9 00 00 00 00       	mov    $0x0,%ecx
  8064ea:	89 c7                	mov    %eax,%edi
  8064ec:	48 b8 28 68 80 00 00 	movabs $0x806828,%rax
  8064f3:	00 00 00 
...
00000000008064fa <devsock_write>:
...
devsock_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  806502:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  806506:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
  80650a:	48 89 55 e8          	mov    %rdx,-0x18(%rbp)
	return nsipc_send(fd->fd_sock.sockid, buf, n, 0);
  80650e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  806512:	89 c2                	mov    %eax,%edx
  806514:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806518:	8b 40 0c             	mov    0xc(%rax),%eax
  80651b:	48 8b 75 f0          	mov    -0x10(%rbp),%rsi
  80651f:	b9 00 00 00 00       	mov    $0x0,%ecx
  806524:	89 c7                	mov    %eax,%edi
  806526:	48 b8 f4 68 80 00 00 	movabs $0x8068f4,%rax
  80652d:	00 00 00 
  806530:	ff d0                	callq  *%rax
}
  806532:	c9                   	leaveq 
  806533:	c3                   	retq   

0000000000806534 <devsock_stat>:
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  806538:	48 83 ec 10          	sub    $0x10,%rsp
  80653c:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  806540:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
	strcpy(stat->st_name, "<sock>");
  806544:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806548:	48 be a8 7f 80 00 00 	movabs $0x807fa8,%rsi
  80654f:	00 00 00 
  806552:	48 89 c7             	mov    %rax,%rdi
  806555:	48 b8 d4 41 80 00 00 	movabs $0x8041d4,%rax
  80655c:	00 00 00 
  80655f:	ff d0                	callq  *%rax
	return 0;
...
0000000000806568 <socket>:

int
socket(int domain, int type, int protocol)
{
  806568:	55                   	push   %rbp
  806569:	48 89 e5             	mov    %rsp,%rbp
  80656c:	48 83 ec 20          	sub    $0x20,%rsp
  806570:	89 7d ec             	mov    %edi,-0x14(%rbp)
  806573:	89 75 e8             	mov    %esi,-0x18(%rbp)
  806576:	89 55 e4             	mov    %edx,-0x1c(%rbp)
	int r;
	if ((r = nsipc_socket(domain, type, protocol)) < 0)
  806579:	8b 55 e4             	mov    -0x1c(%rbp),%edx
  80657c:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  80657f:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806582:	89 ce                	mov    %ecx,%esi
  806584:	89 c7                	mov    %eax,%edi
  806586:	48 b8 ac 69 80 00 00 	movabs $0x8069ac,%rax
  80658d:	00 00 00 
  806590:	ff d0                	callq  *%rax
  806592:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806595:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806599:	79 05                	jns    8065a0 <socket+0x38>
		return r;
  80659b:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80659e:	eb 11                	jmp    8065b1 <socket+0x49>
	return alloc_sockfd(r);
  8065a0:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8065a3:	89 c7                	mov    %eax,%edi
  8065a5:	48 b8 4a 62 80 00 00 	movabs $0x80624a,%rax
  8065ac:	00 00 00 
  8065af:	ff d0                	callq  *%rax
}
  8065b1:	c9                   	leaveq 
  8065b2:	c3                   	retq   

00000000008065b3 <nsipc>:
...
{
  8065b3:	55                   	push   %rbp
  8065b4:	48 89 e5             	mov    %rsp,%rbp
  8065b7:	48 83 ec 10          	sub    $0x10,%rsp
  8065bb:	89 7d fc             	mov    %edi,-0x4(%rbp)
	static envid_t nsenv;
	if (nsenv == 0)
  8065be:	48 b8 08 30 81 00 00 	movabs $0x813008,%rax
  8065c5:	00 00 00 
  8065c8:	8b 00                	mov    (%rax),%eax
  8065ca:	85 c0                	test   %eax,%eax
  8065cc:	75 1d                	jne    8065eb <nsipc+0x38>
		nsenv = ipc_find_env(ENV_TYPE_NS);
  8065ce:	bf 02 00 00 00       	mov    $0x2,%edi
  8065d3:	48 b8 e4 50 80 00 00 	movabs $0x8050e4,%rax
  8065da:	00 00 00 
  8065dd:	ff d0                	callq  *%rax
  8065df:	48 ba 08 30 81 00 00 	movabs $0x813008,%rdx
  8065e6:	00 00 00 
  8065e9:	89 02                	mov    %eax,(%rdx)
  ...
  8065eb:	48 b8 08 30 81 00 00 	movabs $0x813008,%rax
  8065f2:	00 00 00 
  8065f5:	8b 00                	mov    (%rax),%eax
  8065f7:	8b 75 fc             	mov    -0x4(%rbp),%esi
  8065fa:	b9 07 00 00 00       	mov    $0x7,%ecx
  8065ff:	48 ba 00 60 81 00 00 	movabs $0x816000,%rdx
  806606:	00 00 00 
  806609:	89 c7                	mov    %eax,%edi
  80660b:	48 b8 82 50 80 00 00 	movabs $0x805082,%rax
  806612:	00 00 00 
  806615:	ff d0                	callq  *%rax
	return ipc_recv(NULL, NULL, NULL);
  806617:	ba 00 00 00 00       	mov    $0x0,%edx
  80661c:	be 00 00 00 00       	mov    $0x0,%esi
  806621:	bf 00 00 00 00       	mov    $0x0,%edi
  806626:	48 b8 7c 4f 80 00 00 	movabs $0x804f7c,%rax
  80662d:	00 00 00 
  806630:	ff d0                	callq  *%rax
}
  806632:	c9                   	leaveq 
  806633:	c3                   	retq   

0000000000806634 <nsipc_accept>:
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  806638:	48 83 ec 30          	sub    $0x30,%rsp
  80663c:	89 7d ec             	mov    %edi,-0x14(%rbp)
  80663f:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  806643:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	int r;

	nsipcbuf.accept.req_s = s;
  806647:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  80664e:	00 00 00 
  806651:	8b 55 ec             	mov    -0x14(%rbp),%edx
  806654:	89 10                	mov    %edx,(%rax)
	if ((r = nsipc(NSREQ_ACCEPT)) >= 0) {
  806656:	bf 01 00 00 00       	mov    $0x1,%edi
  80665b:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  806662:	00 00 00 
  806665:	ff d0                	callq  *%rax
  806667:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80666a:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80666e:	78 3e                	js     8066ae <nsipc_accept+0x7a>
		struct Nsret_accept *ret = &nsipcbuf.acceptRet;
  806670:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806677:	00 00 00 
  80667a:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
		memmove(addr, &ret->ret_addr, ret->ret_addrlen);
  80667e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806682:	8b 40 10             	mov    0x10(%rax),%eax
  806685:	89 c2                	mov    %eax,%edx
  806687:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
  80668b:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  80668f:	48 89 ce             	mov    %rcx,%rsi
  806692:	48 89 c7             	mov    %rax,%rdi
  806695:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  80669c:	00 00 00 
  80669f:	ff d0                	callq  *%rax
		*addrlen = ret->ret_addrlen;
  8066a1:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8066a5:	8b 50 10             	mov    0x10(%rax),%edx
  8066a8:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  8066ac:	89 10                	mov    %edx,(%rax)
	}
	return r;
...
nsipc_bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  8066b7:	48 83 ec 10          	sub    $0x10,%rsp
  8066bb:	89 7d fc             	mov    %edi,-0x4(%rbp)
  8066be:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
  8066c2:	89 55 f8             	mov    %edx,-0x8(%rbp)
	nsipcbuf.bind.req_s = s;
  8066c5:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8066cc:	00 00 00 
  8066cf:	8b 55 fc             	mov    -0x4(%rbp),%edx
  8066d2:	89 10                	mov    %edx,(%rax)
	memmove(&nsipcbuf.bind.req_name, name, namelen);
  8066d4:	8b 55 f8             	mov    -0x8(%rbp),%edx
  8066d7:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8066db:	48 89 c6             	mov    %rax,%rsi
  8066de:	48 bf 04 60 81 00 00 	movabs $0x816004,%rdi
  8066e5:	00 00 00 
  8066e8:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  8066ef:	00 00 00 
  8066f2:	ff d0                	callq  *%rax
	nsipcbuf.bind.req_namelen = namelen;
  8066f4:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8066fb:	00 00 00 
  8066fe:	8b 55 f8             	mov    -0x8(%rbp),%edx
  806701:	89 50 14             	mov    %edx,0x14(%rax)
	return nsipc(NSREQ_BIND);
  806704:	bf 02 00 00 00       	mov    $0x2,%edi
  806709:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  806710:	00 00 00 
...
0000000000806717 <nsipc_shutdown>:

int
nsipc_shutdown(int s, int how)
{
  806717:	55                   	push   %rbp
  806718:	48 89 e5             	mov    %rsp,%rbp
  80671b:	48 83 ec 10          	sub    $0x10,%rsp
  80671f:	89 7d fc             	mov    %edi,-0x4(%rbp)
  806722:	89 75 f8             	mov    %esi,-0x8(%rbp)
	nsipcbuf.shutdown.req_s = s;
  806725:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  80672c:	00 00 00 
  80672f:	8b 55 fc             	mov    -0x4(%rbp),%edx
  806732:	89 10                	mov    %edx,(%rax)
	nsipcbuf.shutdown.req_how = how;
  806734:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  80673b:	00 00 00 
  80673e:	8b 55 f8             	mov    -0x8(%rbp),%edx
  806741:	89 50 04             	mov    %edx,0x4(%rax)
	return nsipc(NSREQ_SHUTDOWN);
  806744:	bf 03 00 00 00       	mov    $0x3,%edi
  806749:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  806750:	00 00 00 
  806753:	ff d0                	callq  *%rax
}
  806755:	c9                   	leaveq 
  806756:	c3                   	retq   

0000000000806757 <nsipc_close>:

int
nsipc_close(int s)
{
  806757:	55                   	push   %rbp
  806758:	48 89 e5             	mov    %rsp,%rbp
  80675b:	48 83 ec 10          	sub    $0x10,%rsp
  80675f:	89 7d fc             	mov    %edi,-0x4(%rbp)
	nsipcbuf.close.req_s = s;
  806762:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806769:	00 00 00 
  80676c:	8b 55 fc             	mov    -0x4(%rbp),%edx
  80676f:	89 10                	mov    %edx,(%rax)
	return nsipc(NSREQ_CLOSE);
  806771:	bf 04 00 00 00       	mov    $0x4,%edi
  806776:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  80677d:	00 00 00 
  806780:	ff d0                	callq  *%rax
}
  806782:	c9                   	leaveq 
  806783:	c3                   	retq   

0000000000806784 <nsipc_connect>:

int
nsipc_connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  806784:	55                   	push   %rbp
  806785:	48 89 e5             	mov    %rsp,%rbp
  806788:	48 83 ec 10          	sub    $0x10,%rsp
  80678c:	89 7d fc             	mov    %edi,-0x4(%rbp)
  80678f:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
  806793:	89 55 f8             	mov    %edx,-0x8(%rbp)
	nsipcbuf.connect.req_s = s;
  806796:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  80679d:	00 00 00 
  8067a0:	8b 55 fc             	mov    -0x4(%rbp),%edx
  8067a3:	89 10                	mov    %edx,(%rax)
	memmove(&nsipcbuf.connect.req_name, name, namelen);
  8067a5:	8b 55 f8             	mov    -0x8(%rbp),%edx
  8067a8:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8067ac:	48 89 c6             	mov    %rax,%rsi
  8067af:	48 bf 04 60 81 00 00 	movabs $0x816004,%rdi
  8067b6:	00 00 00 
  8067b9:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  8067c0:	00 00 00 
  8067c3:	ff d0                	callq  *%rax
	nsipcbuf.connect.req_namelen = namelen;
  8067c5:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8067cc:	00 00 00 
  8067cf:	8b 55 f8             	mov    -0x8(%rbp),%edx
  8067d2:	89 50 14             	mov    %edx,0x14(%rax)
	return nsipc(NSREQ_CONNECT);
  8067d5:	bf 05 00 00 00       	mov    $0x5,%edi
  8067da:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  8067e1:	00 00 00 
...
00000000008067e8 <nsipc_listen>:

int
nsipc_listen(int s, int backlog)
{
  8067e8:	55                   	push   %rbp
  8067e9:	48 89 e5             	mov    %rsp,%rbp
  8067ec:	48 83 ec 10          	sub    $0x10,%rsp
  8067f0:	89 7d fc             	mov    %edi,-0x4(%rbp)
  8067f3:	89 75 f8             	mov    %esi,-0x8(%rbp)
	nsipcbuf.listen.req_s = s;
  8067f6:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8067fd:	00 00 00 
  806800:	8b 55 fc             	mov    -0x4(%rbp),%edx
  806803:	89 10                	mov    %edx,(%rax)
	nsipcbuf.listen.req_backlog = backlog;
  806805:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  80680c:	00 00 00 
  80680f:	8b 55 f8             	mov    -0x8(%rbp),%edx
  806812:	89 50 04             	mov    %edx,0x4(%rax)
	return nsipc(NSREQ_LISTEN);
  806815:	bf 06 00 00 00       	mov    $0x6,%edi
  80681a:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  806821:	00 00 00 
  806824:	ff d0                	callq  *%rax
}
  806826:	c9                   	leaveq 
  806827:	c3                   	retq   

0000000000806828 <nsipc_recv>:

int
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  806828:	55                   	push   %rbp
  806829:	48 89 e5             	mov    %rsp,%rbp
  80682c:	48 83 ec 30          	sub    $0x30,%rsp
  806830:	89 7d ec             	mov    %edi,-0x14(%rbp)
  806833:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  806837:	89 55 e8             	mov    %edx,-0x18(%rbp)
  80683a:	89 4d dc             	mov    %ecx,-0x24(%rbp)
	int r;

	nsipcbuf.recv.req_s = s;
  80683d:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806844:	00 00 00 
  806847:	8b 55 ec             	mov    -0x14(%rbp),%edx
  80684a:	89 10                	mov    %edx,(%rax)
	nsipcbuf.recv.req_len = len;
  80684c:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806853:	00 00 00 
  806856:	8b 55 e8             	mov    -0x18(%rbp),%edx
  806859:	89 50 04             	mov    %edx,0x4(%rax)
	nsipcbuf.recv.req_flags = flags;
  80685c:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806863:	00 00 00 
  806866:	8b 55 dc             	mov    -0x24(%rbp),%edx
  806869:	89 50 08             	mov    %edx,0x8(%rax)

	if ((r = nsipc(NSREQ_RECV)) >= 0) {
  80686c:	bf 07 00 00 00       	mov    $0x7,%edi
  806871:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  806878:	00 00 00 
  80687b:	ff d0                	callq  *%rax
  80687d:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806880:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806884:	78 69                	js     8068ef <nsipc_recv+0xc7>
		assert(r < 1600 && r <= len);
  806886:	81 7d fc 3f 06 00 00 	cmpl   $0x63f,-0x4(%rbp)
  80688d:	7f 08                	jg     806897 <nsipc_recv+0x6f>
  80688f:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806892:	3b 45 e8             	cmp    -0x18(%rbp),%eax
  806895:	7e 35                	jle    8068cc <nsipc_recv+0xa4>
  806897:	48 b9 af 7f 80 00 00 	movabs $0x807faf,%rcx
  80689e:	00 00 00 
  8068a1:	48 ba c4 7f 80 00 00 	movabs $0x807fc4,%rdx
  8068a8:	00 00 00 
  8068ab:	be 61 00 00 00       	mov    $0x61,%esi
  8068b0:	48 bf d9 7f 80 00 00 	movabs $0x807fd9,%rdi
  8068b7:	00 00 00 
  8068ba:	b8 00 00 00 00       	mov    $0x0,%eax
  8068bf:	49 b8 e6 33 80 00 00 	movabs $0x8033e6,%r8
  8068c6:	00 00 00 
  8068c9:	41 ff d0             	callq  *%r8
		memmove(mem, nsipcbuf.recvRet.ret_buf, r);
  8068cc:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8068cf:	48 63 d0             	movslq %eax,%rdx
  8068d2:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  8068d6:	48 be 00 60 81 00 00 	movabs $0x816000,%rsi
  8068dd:	00 00 00 
  8068e0:	48 89 c7             	mov    %rax,%rdi
  8068e3:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  8068ea:	00 00 00 
  8068ed:	ff d0                	callq  *%rax
	}

	return r;
  8068ef:	8b 45 fc             	mov    -0x4(%rbp),%eax
}
  8068f2:	c9                   	leaveq 
  8068f3:	c3                   	retq   

00000000008068f4 <nsipc_send>:

int
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  8068f4:	55                   	push   %rbp
  8068f5:	48 89 e5             	mov    %rsp,%rbp
  8068f8:	48 83 ec 20          	sub    $0x20,%rsp
  8068fc:	89 7d fc             	mov    %edi,-0x4(%rbp)
  8068ff:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
  806903:	89 55 f8             	mov    %edx,-0x8(%rbp)
  806906:	89 4d ec             	mov    %ecx,-0x14(%rbp)
	nsipcbuf.send.req_s = s;
  806909:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806910:	00 00 00 
  806913:	8b 55 fc             	mov    -0x4(%rbp),%edx
  806916:	89 10                	mov    %edx,(%rax)
	assert(size < 1600);
  806918:	81 7d f8 3f 06 00 00 	cmpl   $0x63f,-0x8(%rbp)
  80691f:	7e 35                	jle    806956 <nsipc_send+0x62>
  806921:	48 b9 e5 7f 80 00 00 	movabs $0x807fe5,%rcx
  806928:	00 00 00 
  80692b:	48 ba c4 7f 80 00 00 	movabs $0x807fc4,%rdx
  806932:	00 00 00 
  806935:	be 6c 00 00 00       	mov    $0x6c,%esi
  80693a:	48 bf d9 7f 80 00 00 	movabs $0x807fd9,%rdi
  806941:	00 00 00 
  806944:	b8 00 00 00 00       	mov    $0x0,%eax
  806949:	49 b8 e6 33 80 00 00 	movabs $0x8033e6,%r8
  806950:	00 00 00 
  806953:	41 ff d0             	callq  *%r8
	memmove(&nsipcbuf.send.req_buf, buf, size);
  806956:	8b 45 f8             	mov    -0x8(%rbp),%eax
  806959:	48 63 d0             	movslq %eax,%rdx
  80695c:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806960:	48 89 c6             	mov    %rax,%rsi
  806963:	48 bf 0c 60 81 00 00 	movabs $0x81600c,%rdi
  80696a:	00 00 00 
  80696d:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  806974:	00 00 00 
  806977:	ff d0                	callq  *%rax
	nsipcbuf.send.req_size = size;
  806979:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806980:	00 00 00 
  806983:	8b 55 f8             	mov    -0x8(%rbp),%edx
  806986:	89 50 04             	mov    %edx,0x4(%rax)
	nsipcbuf.send.req_flags = flags;
  806989:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  806990:	00 00 00 
  806993:	8b 55 ec             	mov    -0x14(%rbp),%edx
  806996:	89 50 08             	mov    %edx,0x8(%rax)
	return nsipc(NSREQ_SEND);
  806999:	bf 08 00 00 00       	mov    $0x8,%edi
  80699e:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  8069a5:	00 00 00 
  8069a8:	ff d0                	callq  *%rax
}
  8069aa:	c9                   	leaveq 
  8069ab:	c3                   	retq   

00000000008069ac <nsipc_socket>:

int
nsipc_socket(int domain, int type, int protocol)
{
  8069ac:	55                   	push   %rbp
  8069ad:	48 89 e5             	mov    %rsp,%rbp
  8069b0:	48 83 ec 10          	sub    $0x10,%rsp
  8069b4:	89 7d fc             	mov    %edi,-0x4(%rbp)
  8069b7:	89 75 f8             	mov    %esi,-0x8(%rbp)
  8069ba:	89 55 f4             	mov    %edx,-0xc(%rbp)
	nsipcbuf.socket.req_domain = domain;
  8069bd:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8069c4:	00 00 00 
  8069c7:	8b 55 fc             	mov    -0x4(%rbp),%edx
  8069ca:	89 10                	mov    %edx,(%rax)
	nsipcbuf.socket.req_type = type;
  8069cc:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8069d3:	00 00 00 
  8069d6:	8b 55 f8             	mov    -0x8(%rbp),%edx
  8069d9:	89 50 04             	mov    %edx,0x4(%rax)
	nsipcbuf.socket.req_protocol = protocol;
  8069dc:	48 b8 00 60 81 00 00 	movabs $0x816000,%rax
  8069e3:	00 00 00 
  8069e6:	8b 55 f4             	mov    -0xc(%rbp),%edx
  8069e9:	89 50 08             	mov    %edx,0x8(%rax)
	return nsipc(NSREQ_SOCKET);
  8069ec:	bf 09 00 00 00       	mov    $0x9,%edi
  8069f1:	48 b8 b3 65 80 00 00 	movabs $0x8065b3,%rax
  8069f8:	00 00 00 
  8069fb:	ff d0                	callq  *%rax
}
  8069fd:	c9                   	leaveq 
  8069fe:	c3                   	retq   

00000000008069ff <pipe>:
...
{
  8069ff:	55                   	push   %rbp
  806a00:	48 89 e5             	mov    %rsp,%rbp
  806a03:	53                   	push   %rbx
  806a04:	48 83 ec 38          	sub    $0x38,%rsp
  806a08:	48 89 7d c8          	mov    %rdi,-0x38(%rbp)
	int r;
	struct Fd *fd0, *fd1;
	void *va;
	...
	if ((r = fd_alloc(&fd0)) < 0
  806a0c:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
  806a10:	48 89 c7             	mov    %rax,%rdi
  806a13:	48 b8 b4 51 80 00 00 	movabs $0x8051b4,%rax
  806a1a:	00 00 00 
  806a1d:	ff d0                	callq  *%rax
  806a1f:	89 45 ec             	mov    %eax,-0x14(%rbp)
  806a22:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  806a26:	0f 88 bf 01 00 00    	js     806beb <pipe+0x1ec>
            || (r = sys_page_alloc(0, fd0, PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  806a2c:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806a30:	ba 07 04 00 00       	mov    $0x407,%edx
  806a35:	48 89 c6             	mov    %rax,%rsi
  806a38:	bf 00 00 00 00       	mov    $0x0,%edi
  806a3d:	48 b8 03 4b 80 00 00 	movabs $0x804b03,%rax
  806a44:	00 00 00 
  806a47:	ff d0                	callq  *%rax
  806a49:	89 45 ec             	mov    %eax,-0x14(%rbp)
  806a4c:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  806a50:	0f 88 95 01 00 00    	js     806beb <pipe+0x1ec>
		goto err;

	if ((r = fd_alloc(&fd1)) < 0
  806a56:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
  806a5a:	48 89 c7             	mov    %rax,%rdi
  806a5d:	48 b8 b4 51 80 00 00 	movabs $0x8051b4,%rax
  806a64:	00 00 00 
  806a67:	ff d0                	callq  *%rax
  806a69:	89 45 ec             	mov    %eax,-0x14(%rbp)
  806a6c:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  806a70:	0f 88 5d 01 00 00    	js     806bd3 <pipe+0x1d4>
            || (r = sys_page_alloc(0, fd1, PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  806a76:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806a7a:	ba 07 04 00 00       	mov    $0x407,%edx
  806a7f:	48 89 c6             	mov    %rax,%rsi
  806a82:	bf 00 00 00 00       	mov    $0x0,%edi
  806a87:	48 b8 03 4b 80 00 00 	movabs $0x804b03,%rax
  806a8e:	00 00 00 
  806a91:	ff d0                	callq  *%rax
  806a93:	89 45 ec             	mov    %eax,-0x14(%rbp)
  806a96:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  806a9a:	0f 88 33 01 00 00    	js     806bd3 <pipe+0x1d4>
		goto err1;

	// allocate the pipe structure as first data page in both
	va = fd2data(fd0);
  806aa0:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806aa4:	48 89 c7             	mov    %rax,%rdi
  806aa7:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806aae:	00 00 00 
  806ab1:	ff d0                	callq  *%rax
  806ab3:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
	if ((r = sys_page_alloc(0, va, PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  806ab7:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806abb:	ba 07 04 00 00       	mov    $0x407,%edx
  806ac0:	48 89 c6             	mov    %rax,%rsi
  806ac3:	bf 00 00 00 00       	mov    $0x0,%edi
  806ac8:	48 b8 03 4b 80 00 00 	movabs $0x804b03,%rax
  806acf:	00 00 00 
  806ad2:	ff d0                	callq  *%rax
  806ad4:	89 45 ec             	mov    %eax,-0x14(%rbp)
  806ad7:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  806adb:	79 05                	jns    806ae2 <pipe+0xe3>
		goto err2;
  806add:	e9 d9 00 00 00       	jmpq   806bbb <pipe+0x1bc>
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  806ae2:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806ae6:	48 89 c7             	mov    %rax,%rdi
  806ae9:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806af0:	00 00 00 
  806af3:	ff d0                	callq  *%rax
  806af5:	48 89 c2             	mov    %rax,%rdx
  806af8:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806afc:	41 b8 07 04 00 00    	mov    $0x407,%r8d
  806b02:	48 89 d1             	mov    %rdx,%rcx
  806b05:	ba 00 00 00 00       	mov    $0x0,%edx
  806b0a:	48 89 c6             	mov    %rax,%rsi
  806b0d:	bf 00 00 00 00       	mov    $0x0,%edi
  806b12:	48 b8 53 4b 80 00 00 	movabs $0x804b53,%rax
  806b19:	00 00 00 
  806b1c:	ff d0                	callq  *%rax
  806b1e:	89 45 ec             	mov    %eax,-0x14(%rbp)
  806b21:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
  806b25:	79 1b                	jns    806b42 <pipe+0x143>
		goto err3;
  806b27:	90                   	nop
	pfd[0] = fd2num(fd0);
	pfd[1] = fd2num(fd1);
...
err3:
	sys_page_unmap(0, va);
  806b28:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806b2c:	48 89 c6             	mov    %rax,%rsi
  806b2f:	bf 00 00 00 00       	mov    $0x0,%edi
  806b34:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  806b3b:	00 00 00 
  806b3e:	ff d0                	callq  *%rax
  806b40:	eb 79                	jmp    806bbb <pipe+0x1bc>
		goto err2;
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
		goto err3;
  ...
  806b42:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806b46:	48 ba 60 21 81 00 00 	movabs $0x812160,%rdx
  806b4d:	00 00 00 
  806b50:	8b 12                	mov    (%rdx),%edx
  806b52:	89 10                	mov    %edx,(%rax)
	fd0->fd_omode = O_RDONLY;
  806b54:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806b58:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%rax)

	fd1->fd_dev_id = devpipe.dev_id;
  806b5f:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806b63:	48 ba 60 21 81 00 00 	movabs $0x812160,%rdx
  806b6a:	00 00 00 
  806b6d:	8b 12                	mov    (%rdx),%edx
  806b6f:	89 10                	mov    %edx,(%rax)
	fd1->fd_omode = O_WRONLY;
  806b71:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806b75:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%rax)
  ...
  806b80:	48 89 c7             	mov    %rax,%rdi
  806b83:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  806b8a:	00 00 00 
  806b8d:	ff d0                	callq  *%rax
  806b8f:	89 c2                	mov    %eax,%edx
  806b91:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  806b95:	89 10                	mov    %edx,(%rax)
	pfd[1] = fd2num(fd1);
  806b97:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  806b9b:	48 8d 58 04          	lea    0x4(%rax),%rbx
  806b9f:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806ba3:	48 89 c7             	mov    %rax,%rdi
  806ba6:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  806bad:	00 00 00 
  806bb0:	ff d0                	callq  *%rax
  806bb2:	89 03                	mov    %eax,(%rbx)
	return 0;
  806bb4:	b8 00 00 00 00       	mov    $0x0,%eax
  806bb9:	eb 33                	jmp    806bee <pipe+0x1ef>

err3:
	sys_page_unmap(0, va);
err2:
	sys_page_unmap(0, fd1);
  806bbb:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806bbf:	48 89 c6             	mov    %rax,%rsi
  806bc2:	bf 00 00 00 00       	mov    $0x0,%edi
  806bc7:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  806bce:	00 00 00 
  806bd1:	ff d0                	callq  *%rax
err1:
	sys_page_unmap(0, fd0);
  806bd3:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806bd7:	48 89 c6             	mov    %rax,%rsi
  806bda:	bf 00 00 00 00       	mov    $0x0,%edi
  806bdf:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  806be6:	00 00 00 
  806be9:	ff d0                	callq  *%rax
err:
	return r;
  806beb:	8b 45 ec             	mov    -0x14(%rbp),%eax
}
  806bee:	48 83 c4 38          	add    $0x38,%rsp
  806bf2:	5b                   	pop    %rbx
  806bf3:	5d                   	pop    %rbp
  806bf4:	c3                   	retq   

0000000000806bf5 <_pipeisclosed>:

static int
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  806bf5:	55                   	push   %rbp
  806bf6:	48 89 e5             	mov    %rsp,%rbp
  806bf9:	53                   	push   %rbx
  806bfa:	48 83 ec 28          	sub    $0x28,%rsp
  806bfe:	48 89 7d d8          	mov    %rdi,-0x28(%rbp)
  806c02:	48 89 75 d0          	mov    %rsi,-0x30(%rbp)
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  806c06:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  806c0d:	00 00 00 
  806c10:	48 8b 00             	mov    (%rax),%rax
  806c13:	8b 80 d8 00 00 00    	mov    0xd8(%rax),%eax
  806c19:	89 45 ec             	mov    %eax,-0x14(%rbp)
		ret = pageref(fd) == pageref(p);
  806c1c:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806c20:	48 89 c7             	mov    %rax,%rdi
  806c23:	48 b8 6a 61 80 00 00 	movabs $0x80616a,%rax
  806c2a:	00 00 00 
  806c2d:	ff d0                	callq  *%rax
  806c2f:	89 c3                	mov    %eax,%ebx
  806c31:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806c35:	48 89 c7             	mov    %rax,%rdi
  806c38:	48 b8 6a 61 80 00 00 	movabs $0x80616a,%rax
  806c3f:	00 00 00 
  806c42:	ff d0                	callq  *%rax
  806c44:	39 c3                	cmp    %eax,%ebx
  806c46:	0f 94 c0             	sete   %al
  806c49:	0f b6 c0             	movzbl %al,%eax
  806c4c:	89 45 e8             	mov    %eax,-0x18(%rbp)
		nn = thisenv->env_runs;
  806c4f:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  806c56:	00 00 00 
  806c59:	48 8b 00             	mov    (%rax),%rax
  806c5c:	8b 80 d8 00 00 00    	mov    0xd8(%rax),%eax
  806c62:	89 45 e4             	mov    %eax,-0x1c(%rbp)
		if (n == nn)
  806c65:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806c68:	3b 45 e4             	cmp    -0x1c(%rbp),%eax
  806c6b:	75 05                	jne    806c72 <_pipeisclosed+0x7d>
			return ret;
  806c6d:	8b 45 e8             	mov    -0x18(%rbp),%eax
  806c70:	eb 4f                	jmp    806cc1 <_pipeisclosed+0xcc>
		if (n != nn && ret == 1)
  806c72:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806c75:	3b 45 e4             	cmp    -0x1c(%rbp),%eax
  806c78:	74 42                	je     806cbc <_pipeisclosed+0xc7>
  806c7a:	83 7d e8 01          	cmpl   $0x1,-0x18(%rbp)
  806c7e:	75 3c                	jne    806cbc <_pipeisclosed+0xc7>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  806c80:	48 b8 20 30 81 00 00 	movabs $0x813020,%rax
  806c87:	00 00 00 
  806c8a:	48 8b 00             	mov    (%rax),%rax
  806c8d:	8b 90 d8 00 00 00    	mov    0xd8(%rax),%edx
  806c93:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  806c96:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806c99:	89 c6                	mov    %eax,%esi
  806c9b:	48 bf f6 7f 80 00 00 	movabs $0x807ff6,%rdi
  806ca2:	00 00 00 
  806ca5:	b8 00 00 00 00       	mov    $0x0,%eax
  806caa:	49 b8 1f 36 80 00 00 	movabs $0x80361f,%r8
  806cb1:	00 00 00 
  806cb4:	41 ff d0             	callq  *%r8
	}
  806cb7:	e9 4a ff ff ff       	jmpq   806c06 <_pipeisclosed+0x11>
  806cbc:	e9 45 ff ff ff       	jmpq   806c06 <_pipeisclosed+0x11>
}
  806cc1:	48 83 c4 28          	add    $0x28,%rsp
  806cc5:	5b                   	pop    %rbx
  806cc6:	5d                   	pop    %rbp
  806cc7:	c3                   	retq   

0000000000806cc8 <pipeisclosed>:

int
pipeisclosed(int fdnum)
{
  806cc8:	55                   	push   %rbp
  806cc9:	48 89 e5             	mov    %rsp,%rbp
  806ccc:	48 83 ec 30          	sub    $0x30,%rsp
  806cd0:	89 7d dc             	mov    %edi,-0x24(%rbp)
	struct Fd *fd;
	struct Pipe *p;
	int r;

	if ((r = fd_lookup(fdnum, &fd)) < 0)
  806cd3:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
  806cd7:	8b 45 dc             	mov    -0x24(%rbp),%eax
  806cda:	48 89 d6             	mov    %rdx,%rsi
  806cdd:	89 c7                	mov    %eax,%edi
  806cdf:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  806ce6:	00 00 00 
  806ce9:	ff d0                	callq  *%rax
  806ceb:	89 45 fc             	mov    %eax,-0x4(%rbp)
  806cee:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  806cf2:	79 05                	jns    806cf9 <pipeisclosed+0x31>
		return r;
  806cf4:	8b 45 fc             	mov    -0x4(%rbp),%eax
  806cf7:	eb 31                	jmp    806d2a <pipeisclosed+0x62>
	p = (struct Pipe*) fd2data(fd);
  806cf9:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  806cfd:	48 89 c7             	mov    %rax,%rdi
  806d00:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806d07:	00 00 00 
  806d0a:	ff d0                	callq  *%rax
  806d0c:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
	return _pipeisclosed(fd, p);
  806d10:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  806d14:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  806d18:	48 89 d6             	mov    %rdx,%rsi
  806d1b:	48 89 c7             	mov    %rax,%rdi
  806d1e:	48 b8 f5 6b 80 00 00 	movabs $0x806bf5,%rax
  806d25:	00 00 00 
  806d28:	ff d0                	callq  *%rax
}
  806d2a:	c9                   	leaveq 
  806d2b:	c3                   	retq   

0000000000806d2c <devpipe_read>:

static ssize_t
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  806d2c:	55                   	push   %rbp
  806d2d:	48 89 e5             	mov    %rsp,%rbp
  806d30:	48 83 ec 40          	sub    $0x40,%rsp
  806d34:	48 89 7d d8          	mov    %rdi,-0x28(%rbp)
  806d38:	48 89 75 d0          	mov    %rsi,-0x30(%rbp)
  806d3c:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
	uint8_t *buf;
	size_t i;
	struct Pipe *p;

	p = (struct Pipe*)fd2data(fd);
  806d40:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806d44:	48 89 c7             	mov    %rax,%rdi
  806d47:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806d4e:	00 00 00 
  806d51:	ff d0                	callq  *%rax
  806d53:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);

	buf = vbuf;
  806d57:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806d5b:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
	for (i = 0; i < n; i++) {
  806d5f:	48 c7 45 f8 00 00 00 	movq   $0x0,-0x8(%rbp)
  806d66:	00 
  806d67:	e9 92 00 00 00       	jmpq   806dfe <devpipe_read+0xd2>
		while (p->p_rpos == p->p_wpos) {
  806d6c:	eb 41                	jmp    806daf <devpipe_read+0x83>
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  806d6e:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
  806d73:	74 09                	je     806d7e <devpipe_read+0x52>
				return i;
  806d75:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806d79:	e9 92 00 00 00       	jmpq   806e10 <devpipe_read+0xe4>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  806d7e:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  806d82:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806d86:	48 89 d6             	mov    %rdx,%rsi
  806d89:	48 89 c7             	mov    %rax,%rdi
  806d8c:	48 b8 f5 6b 80 00 00 	movabs $0x806bf5,%rax
  806d93:	00 00 00 
  806d96:	ff d0                	callq  *%rax
  806d98:	85 c0                	test   %eax,%eax
  806d9a:	74 07                	je     806da3 <devpipe_read+0x77>
				return 0;
  806d9c:	b8 00 00 00 00       	mov    $0x0,%eax
  806da1:	eb 6d                	jmp    806e10 <devpipe_read+0xe4>
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  806da3:	48 b8 c5 4a 80 00 00 	movabs $0x804ac5,%rax
  806daa:	00 00 00 
  806dad:	ff d0                	callq  *%rax
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  806daf:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806db3:	8b 10                	mov    (%rax),%edx
  806db5:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806db9:	8b 40 04             	mov    0x4(%rax),%eax
  806dbc:	39 c2                	cmp    %eax,%edx
  806dbe:	74 ae                	je     806d6e <devpipe_read+0x42>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  806dc0:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806dc4:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
  806dc8:	48 8d 0c 02          	lea    (%rdx,%rax,1),%rcx
  806dcc:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806dd0:	8b 00                	mov    (%rax),%eax
  806dd2:	99                   	cltd   
  806dd3:	c1 ea 1b             	shr    $0x1b,%edx
  806dd6:	01 d0                	add    %edx,%eax
  806dd8:	83 e0 1f             	and    $0x1f,%eax
  806ddb:	29 d0                	sub    %edx,%eax
  806ddd:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  806de1:	48 98                	cltq   
  806de3:	0f b6 44 02 08       	movzbl 0x8(%rdx,%rax,1),%eax
  806de8:	88 01                	mov    %al,(%rcx)
		p->p_rpos++;
  806dea:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806dee:	8b 00                	mov    (%rax),%eax
  806df0:	8d 50 01             	lea    0x1(%rax),%edx
  806df3:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806df7:	89 10                	mov    %edx,(%rax)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  806df9:	48 83 45 f8 01       	addq   $0x1,-0x8(%rbp)
  806dfe:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806e02:	48 3b 45 c8          	cmp    -0x38(%rbp),%rax
  806e06:	0f 82 60 ff ff ff    	jb     806d6c <devpipe_read+0x40>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
	...
	return i;
  806e0c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
}
  806e10:	c9                   	leaveq 
  806e11:	c3                   	retq   

0000000000806e12 <devpipe_write>:

static ssize_t
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  806e12:	55                   	push   %rbp
  806e13:	48 89 e5             	mov    %rsp,%rbp
  806e16:	48 83 ec 40          	sub    $0x40,%rsp
  806e1a:	48 89 7d d8          	mov    %rdi,-0x28(%rbp)
  806e1e:	48 89 75 d0          	mov    %rsi,-0x30(%rbp)
  806e22:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
	const uint8_t *buf;
	size_t i;
	struct Pipe *p;

	p = (struct Pipe*) fd2data(fd);
  806e26:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806e2a:	48 89 c7             	mov    %rax,%rdi
  806e2d:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806e34:	00 00 00 
  806e37:	ff d0                	callq  *%rax
  806e39:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
	if (debug)
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);

	buf = vbuf;
  806e3d:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
  806e41:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
	for (i = 0; i < n; i++) {
  806e45:	48 c7 45 f8 00 00 00 	movq   $0x0,-0x8(%rbp)
  806e4c:	00 
  806e4d:	e9 8e 00 00 00       	jmpq   806ee0 <devpipe_write+0xce>
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  806e52:	eb 31                	jmp    806e85 <devpipe_write+0x73>
			// pipe is full
  ...
  806e58:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  806e5c:	48 89 d6             	mov    %rdx,%rsi
  806e5f:	48 89 c7             	mov    %rax,%rdi
  806e62:	48 b8 f5 6b 80 00 00 	movabs $0x806bf5,%rax
  806e69:	00 00 00 
  806e6c:	ff d0                	callq  *%rax
  806e6e:	85 c0                	test   %eax,%eax
  806e70:	74 07                	je     806e79 <devpipe_write+0x67>
				return 0;
  806e72:	b8 00 00 00 00       	mov    $0x0,%eax
  806e77:	eb 79                	jmp    806ef2 <devpipe_write+0xe0>
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  806e79:	48 b8 c5 4a 80 00 00 	movabs $0x804ac5,%rax
  806e80:	00 00 00 
  806e83:	ff d0                	callq  *%rax
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  806e85:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806e89:	8b 40 04             	mov    0x4(%rax),%eax
  806e8c:	48 63 d0             	movslq %eax,%rdx
  806e8f:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806e93:	8b 00                	mov    (%rax),%eax
  806e95:	48 98                	cltq   
  806e97:	48 83 c0 20          	add    $0x20,%rax
  806e9b:	48 39 c2             	cmp    %rax,%rdx
  806e9e:	73 b4                	jae    806e54 <devpipe_write+0x42>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  806ea0:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806ea4:	8b 40 04             	mov    0x4(%rax),%eax
  806ea7:	99                   	cltd   
  806ea8:	c1 ea 1b             	shr    $0x1b,%edx
  806eab:	01 d0                	add    %edx,%eax
  806ead:	83 e0 1f             	and    $0x1f,%eax
  806eb0:	29 d0                	sub    %edx,%eax
  806eb2:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  806eb6:	48 8b 4d e8          	mov    -0x18(%rbp),%rcx
  806eba:	48 01 ca             	add    %rcx,%rdx
  806ebd:	0f b6 0a             	movzbl (%rdx),%ecx
  806ec0:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  806ec4:	48 98                	cltq   
  806ec6:	88 4c 02 08          	mov    %cl,0x8(%rdx,%rax,1)
		p->p_wpos++;
  806eca:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806ece:	8b 40 04             	mov    0x4(%rax),%eax
  806ed1:	8d 50 01             	lea    0x1(%rax),%edx
  806ed4:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  806ed8:	89 50 04             	mov    %edx,0x4(%rax)
	if (debug)
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  806edb:	48 83 45 f8 01       	addq   $0x1,-0x8(%rbp)
  806ee0:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806ee4:	48 3b 45 c8          	cmp    -0x38(%rbp),%rax
  806ee8:	0f 82 64 ff ff ff    	jb     806e52 <devpipe_write+0x40>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
	...
	return i;
  806eee:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
}
  806ef2:	c9                   	leaveq 
  806ef3:	c3                   	retq   

0000000000806ef4 <devpipe_stat>:

static int
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  806ef4:	55                   	push   %rbp
  806ef5:	48 89 e5             	mov    %rsp,%rbp
  806ef8:	48 83 ec 20          	sub    $0x20,%rsp
  806efc:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  806f00:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
	struct Pipe *p = (struct Pipe*) fd2data(fd);
  806f04:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  806f08:	48 89 c7             	mov    %rax,%rdi
  806f0b:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806f12:	00 00 00 
  806f15:	ff d0                	callq  *%rax
  806f17:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
	strcpy(stat->st_name, "<pipe>");
  806f1b:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806f1f:	48 be 09 80 80 00 00 	movabs $0x808009,%rsi
  806f26:	00 00 00 
  806f29:	48 89 c7             	mov    %rax,%rdi
  806f2c:	48 b8 d4 41 80 00 00 	movabs $0x8041d4,%rax
  806f33:	00 00 00 
  806f36:	ff d0                	callq  *%rax
	stat->st_size = p->p_wpos - p->p_rpos;
  806f38:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806f3c:	8b 50 04             	mov    0x4(%rax),%edx
  806f3f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806f43:	8b 00                	mov    (%rax),%eax
  806f45:	29 c2                	sub    %eax,%edx
  806f47:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806f4b:	89 90 80 00 00 00    	mov    %edx,0x80(%rax)
	stat->st_isdir = 0;
  806f51:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806f55:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%rax)
  806f5c:	00 00 00 
	stat->st_dev = &devpipe;
  806f5f:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  806f63:	48 b9 60 21 81 00 00 	movabs $0x812160,%rcx
  806f6a:	00 00 00 
  806f6d:	48 89 88 88 00 00 00 	mov    %rcx,0x88(%rax)
	return 0;
  806f74:	b8 00 00 00 00       	mov    $0x0,%eax
}
  806f79:	c9                   	leaveq 
  806f7a:	c3                   	retq   

0000000000806f7b <devpipe_close>:
...
devpipe_close(struct Fd *fd)
{
  ...
  806f7f:	48 83 ec 10          	sub    $0x10,%rsp
  806f83:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	(void) sys_page_unmap(0, fd);
  806f87:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806f8b:	48 89 c6             	mov    %rax,%rsi
  806f8e:	bf 00 00 00 00       	mov    $0x0,%edi
  806f93:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  806f9a:	00 00 00 
  806f9d:	ff d0                	callq  *%rax
	return sys_page_unmap(0, fd2data(fd));
  806f9f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  806fa3:	48 89 c7             	mov    %rax,%rdi
  806fa6:	48 b8 89 51 80 00 00 	movabs $0x805189,%rax
  806fad:	00 00 00 
  806fb0:	ff d0                	callq  *%rax
  806fb2:	48 89 c6             	mov    %rax,%rsi
  806fb5:	bf 00 00 00 00       	mov    $0x0,%edi
  806fba:	48 b8 ae 4b 80 00 00 	movabs $0x804bae,%rax
  806fc1:	00 00 00 
...
{
  806fc8:	55                   	push   %rbp
  806fc9:	48 89 e5             	mov    %rsp,%rbp
  806fcc:	48 83 ec 20          	sub    $0x20,%rsp
  806fd0:	89 7d ec             	mov    %edi,-0x14(%rbp)
	char c = ch;
  806fd3:	8b 45 ec             	mov    -0x14(%rbp),%eax
  806fd6:	88 45 ff             	mov    %al,-0x1(%rbp)

	// Unlike standard Unix's putchar,
	// the cputchar function _always_ outputs to the system console.
	sys_cputs(&c, 1);
  806fd9:	48 8d 45 ff          	lea    -0x1(%rbp),%rax
  806fdd:	be 01 00 00 00       	mov    $0x1,%esi
  806fe2:	48 89 c7             	mov    %rax,%rdi
  806fe5:	48 b8 bb 49 80 00 00 	movabs $0x8049bb,%rax
  806fec:	00 00 00 
  806fef:	ff d0                	callq  *%rax
}
  806ff1:	c9                   	leaveq 
  806ff2:	c3                   	retq   

0000000000806ff3 <getchar>:

int
getchar(void)
{
  806ff3:	55                   	push   %rbp
  806ff4:	48 89 e5             	mov    %rsp,%rbp
  806ff7:	48 83 ec 10          	sub    $0x10,%rsp
	int r;
	...
	r = read(0, &c, 1);
  806ffb:	48 8d 45 fb          	lea    -0x5(%rbp),%rax
  806fff:	ba 01 00 00 00       	mov    $0x1,%edx
  807004:	48 89 c6             	mov    %rax,%rsi
  807007:	bf 00 00 00 00       	mov    $0x0,%edi
  80700c:	48 b8 7e 56 80 00 00 	movabs $0x80567e,%rax
  807013:	00 00 00 
  807016:	ff d0                	callq  *%rax
  807018:	89 45 fc             	mov    %eax,-0x4(%rbp)
	if (r < 0)
  80701b:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80701f:	79 05                	jns    807026 <getchar+0x33>
		return r;
  807021:	8b 45 fc             	mov    -0x4(%rbp),%eax
  807024:	eb 14                	jmp    80703a <getchar+0x47>
	if (r < 1)
  807026:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  80702a:	7f 07                	jg     807033 <getchar+0x40>
		return -E_EOF;
  80702c:	b8 f7 ff ff ff       	mov    $0xfffffff7,%eax
  807031:	eb 07                	jmp    80703a <getchar+0x47>
	return c;
  807033:	0f b6 45 fb          	movzbl -0x5(%rbp),%eax
  807037:	0f b6 c0             	movzbl %al,%eax
}
  80703a:	c9                   	leaveq 
  80703b:	c3                   	retq   

000000000080703c <iscons>:
...
{
  80703c:	55                   	push   %rbp
  80703d:	48 89 e5             	mov    %rsp,%rbp
  807040:	48 83 ec 20          	sub    $0x20,%rsp
  807044:	89 7d ec             	mov    %edi,-0x14(%rbp)
	int r;
	struct Fd *fd;

	if ((r = fd_lookup(fdnum, &fd)) < 0)
  807047:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
  80704b:	8b 45 ec             	mov    -0x14(%rbp),%eax
  80704e:	48 89 d6             	mov    %rdx,%rsi
  807051:	89 c7                	mov    %eax,%edi
  807053:	48 b8 4c 52 80 00 00 	movabs $0x80524c,%rax
  80705a:	00 00 00 
  80705d:	ff d0                	callq  *%rax
  80705f:	89 45 fc             	mov    %eax,-0x4(%rbp)
  807062:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  807066:	79 05                	jns    80706d <iscons+0x31>
		return r;
  807068:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80706b:	eb 1a                	jmp    807087 <iscons+0x4b>
	return fd->fd_dev_id == devcons.dev_id;
  80706d:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  807071:	8b 10                	mov    (%rax),%edx
  807073:	48 b8 a0 21 81 00 00 	movabs $0x8121a0,%rax
  80707a:	00 00 00 
  80707d:	8b 00                	mov    (%rax),%eax
  80707f:	39 c2                	cmp    %eax,%edx
  807081:	0f 94 c0             	sete   %al
  807084:	0f b6 c0             	movzbl %al,%eax
}
  807087:	c9                   	leaveq 
  807088:	c3                   	retq   

0000000000807089 <opencons>:
...
opencons(void)
{
  ...
  80708d:	48 83 ec 10          	sub    $0x10,%rsp
	int r;
	struct Fd* fd;

	if ((r = fd_alloc(&fd)) < 0)
  807091:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
  807095:	48 89 c7             	mov    %rax,%rdi
  807098:	48 b8 b4 51 80 00 00 	movabs $0x8051b4,%rax
  80709f:	00 00 00 
  8070a2:	ff d0                	callq  *%rax
  8070a4:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8070a7:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8070ab:	79 05                	jns    8070b2 <opencons+0x29>
		return r;
  8070ad:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8070b0:	eb 5b                	jmp    80710d <opencons+0x84>
	if ((r = sys_page_alloc(0, fd, PTE_P|PTE_U|PTE_W|PTE_SHARE)) < 0)
  8070b2:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8070b6:	ba 07 04 00 00       	mov    $0x407,%edx
  8070bb:	48 89 c6             	mov    %rax,%rsi
  8070be:	bf 00 00 00 00       	mov    $0x0,%edi
  8070c3:	48 b8 03 4b 80 00 00 	movabs $0x804b03,%rax
  8070ca:	00 00 00 
  8070cd:	ff d0                	callq  *%rax
  8070cf:	89 45 fc             	mov    %eax,-0x4(%rbp)
  8070d2:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  8070d6:	79 05                	jns    8070dd <opencons+0x54>
		return r;
  8070d8:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8070db:	eb 30                	jmp    80710d <opencons+0x84>
	fd->fd_dev_id = devcons.dev_id;
  8070dd:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8070e1:	48 ba a0 21 81 00 00 	movabs $0x8121a0,%rdx
  8070e8:	00 00 00 
  8070eb:	8b 12                	mov    (%rdx),%edx
  8070ed:	89 10                	mov    %edx,(%rax)
	fd->fd_omode = O_RDWR;
  8070ef:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8070f3:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%rax)
	return fd2num(fd);
  8070fa:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  8070fe:	48 89 c7             	mov    %rax,%rdi
  807101:	48 b8 66 51 80 00 00 	movabs $0x805166,%rax
  807108:	00 00 00 
  80710b:	ff d0                	callq  *%rax
}
  80710d:	c9                   	leaveq 
  80710e:	c3                   	retq   

000000000080710f <devcons_read>:

static ssize_t
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  80710f:	55                   	push   %rbp
  807110:	48 89 e5             	mov    %rsp,%rbp
  807113:	48 83 ec 30          	sub    $0x30,%rsp
  807117:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
  80711b:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  80711f:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
	int c;

	if (n == 0)
  807123:	48 83 7d d8 00       	cmpq   $0x0,-0x28(%rbp)
  807128:	75 07                	jne    807131 <devcons_read+0x22>
		return 0;
  80712a:	b8 00 00 00 00       	mov    $0x0,%eax
  80712f:	eb 4b                	jmp    80717c <devcons_read+0x6d>

	while ((c = sys_cgetc()) == 0)
  807131:	eb 0c                	jmp    80713f <devcons_read+0x30>
		sys_yield();
  807133:	48 b8 c5 4a 80 00 00 	movabs $0x804ac5,%rax
  80713a:	00 00 00 
  80713d:	ff d0                	callq  *%rax
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  80713f:	48 b8 05 4a 80 00 00 	movabs $0x804a05,%rax
  807146:	00 00 00 
  807149:	ff d0                	callq  *%rax
  80714b:	89 45 fc             	mov    %eax,-0x4(%rbp)
  80714e:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  807152:	74 df                	je     807133 <devcons_read+0x24>
		sys_yield();
	if (c < 0)
  807154:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
  807158:	79 05                	jns    80715f <devcons_read+0x50>
		return c;
  80715a:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80715d:	eb 1d                	jmp    80717c <devcons_read+0x6d>
	if (c == 0x04)	// ctl-d is eof
  80715f:	83 7d fc 04          	cmpl   $0x4,-0x4(%rbp)
  807163:	75 07                	jne    80716c <devcons_read+0x5d>
		return 0;
  807165:	b8 00 00 00 00       	mov    $0x0,%eax
  80716a:	eb 10                	jmp    80717c <devcons_read+0x6d>
	*(char*)vbuf = c;
  80716c:	8b 45 fc             	mov    -0x4(%rbp),%eax
  80716f:	89 c2                	mov    %eax,%edx
  807171:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  807175:	88 10                	mov    %dl,(%rax)
	return 1;
  807177:	b8 01 00 00 00       	mov    $0x1,%eax
}
  80717c:	c9                   	leaveq 
  80717d:	c3                   	retq   

000000000080717e <devcons_write>:

static ssize_t
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  80717e:	55                   	push   %rbp
  80717f:	48 89 e5             	mov    %rsp,%rbp
  807182:	48 81 ec b0 00 00 00 	sub    $0xb0,%rsp
  807189:	48 89 bd 68 ff ff ff 	mov    %rdi,-0x98(%rbp)
  807190:	48 89 b5 60 ff ff ff 	mov    %rsi,-0xa0(%rbp)
  807197:	48 89 95 58 ff ff ff 	mov    %rdx,-0xa8(%rbp)
	int tot, m;
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
  80719e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  8071a5:	eb 76                	jmp    80721d <devcons_write+0x9f>
		m = n - tot;
  8071a7:	48 8b 85 58 ff ff ff 	mov    -0xa8(%rbp),%rax
  8071ae:	89 c2                	mov    %eax,%edx
  8071b0:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8071b3:	29 c2                	sub    %eax,%edx
  8071b5:	89 d0                	mov    %edx,%eax
  8071b7:	89 45 f8             	mov    %eax,-0x8(%rbp)
		if (m > sizeof(buf) - 1)
  8071ba:	8b 45 f8             	mov    -0x8(%rbp),%eax
  8071bd:	83 f8 7f             	cmp    $0x7f,%eax
  8071c0:	76 07                	jbe    8071c9 <devcons_write+0x4b>
			m = sizeof(buf) - 1;
  8071c2:	c7 45 f8 7f 00 00 00 	movl   $0x7f,-0x8(%rbp)
		memmove(buf, (char*)vbuf + tot, m);
  8071c9:	8b 45 f8             	mov    -0x8(%rbp),%eax
  8071cc:	48 63 d0             	movslq %eax,%rdx
  8071cf:	8b 45 fc             	mov    -0x4(%rbp),%eax
  8071d2:	48 63 c8             	movslq %eax,%rcx
  8071d5:	48 8b 85 60 ff ff ff 	mov    -0xa0(%rbp),%rax
  8071dc:	48 01 c1             	add    %rax,%rcx
  8071df:	48 8d 85 70 ff ff ff 	lea    -0x90(%rbp),%rax
  8071e6:	48 89 ce             	mov    %rcx,%rsi
  8071e9:	48 89 c7             	mov    %rax,%rdi
  8071ec:	48 b8 f8 44 80 00 00 	movabs $0x8044f8,%rax
  8071f3:	00 00 00 
  8071f6:	ff d0                	callq  *%rax
		sys_cputs(buf, m);
  8071f8:	8b 45 f8             	mov    -0x8(%rbp),%eax
  8071fb:	48 63 d0             	movslq %eax,%rdx
  8071fe:	48 8d 85 70 ff ff ff 	lea    -0x90(%rbp),%rax
  807205:	48 89 d6             	mov    %rdx,%rsi
  807208:	48 89 c7             	mov    %rax,%rdi
  80720b:	48 b8 bb 49 80 00 00 	movabs $0x8049bb,%rax
  807212:	00 00 00 
  807215:	ff d0                	callq  *%rax
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  807217:	8b 45 f8             	mov    -0x8(%rbp),%eax
  80721a:	01 45 fc             	add    %eax,-0x4(%rbp)
  80721d:	8b 45 fc             	mov    -0x4(%rbp),%eax
  807220:	48 98                	cltq   
  807222:	48 3b 85 58 ff ff ff 	cmp    -0xa8(%rbp),%rax
  807229:	0f 82 78 ff ff ff    	jb     8071a7 <devcons_write+0x29>
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	...
	return tot;
  80722f:	8b 45 fc             	mov    -0x4(%rbp),%eax
}
  807232:	c9                   	leaveq 
  807233:	c3                   	retq   

0000000000807234 <devcons_close>:

static int
devcons_close(struct Fd *fd)
{
  807234:	55                   	push   %rbp
  807235:	48 89 e5             	mov    %rsp,%rbp
  807238:	48 83 ec 08          	sub    $0x8,%rsp
  80723c:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
	USED(fd);

	return 0;
  807240:	b8 00 00 00 00       	mov    $0x0,%eax
}
  807245:	c9                   	leaveq 
  807246:	c3                   	retq   

0000000000807247 <devcons_stat>:

static int
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  807247:	55                   	push   %rbp
  807248:	48 89 e5             	mov    %rsp,%rbp
  80724b:	48 83 ec 10          	sub    $0x10,%rsp
  80724f:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  807253:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
	strcpy(stat->st_name, "<cons>");
  807257:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  80725b:	48 be 15 80 80 00 00 	movabs $0x808015,%rsi
  807262:	00 00 00 
  807265:	48 89 c7             	mov    %rax,%rdi
  807268:	48 b8 d4 41 80 00 00 	movabs $0x8041d4,%rax
  80726f:	00 00 00 
  807272:	ff d0                	callq  *%rax
	return 0;
  807274:	b8 00 00 00 00       	mov    $0x0,%eax
}
  807279:	c9                   	leaveq 
  80727a:	c3                   	retq   
